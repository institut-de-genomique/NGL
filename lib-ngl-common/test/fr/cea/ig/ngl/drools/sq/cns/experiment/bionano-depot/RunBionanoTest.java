...
@DroolsFiles(
	value = {
		...
		"lib-ngl-common/conf/rules/ngl-sq/cns/experiment/bionano-depot/workflow.drl"
	}
)
@PrepareForTest({ InstanceHelpers.class, IGGlobals.class, MongoDBPlugin.class, MongoDBDAO.class })
public class RunBionanoTest extends JUnitTest {
	...
	public void testNumberRules() {						
         ...
         *  1 - rule "Create Run Bionano"
         *  2 - rule "Update type Run SAPHYR"
         *  3 - rule "Save Run Bionano"
	...
	public void testGeneratedRun() {						
        ...
        while (it.hasNext()) {
        	...
        	assertEquals("Code is not as expected", "191221_ILIADE_XPJY-2U6L-PQLG-RNWU_A", runInRule.code);
        	assertEquals("Typecode is not as expected", "RSAPHYR", runInRule.typeCode);

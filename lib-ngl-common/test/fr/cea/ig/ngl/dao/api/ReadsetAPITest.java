...
@PrepareForTest({ FileValidationHelper.class, TreatmentValidationHelper.class, ValidationHelper.class, ReadSetValidationHelper.class, CommonValidationHelper.class })
public class ReadsetAPITest {
	...
	public void testGetByCode() {
		...
		ReadSet readset = ReadsetFactory.getRandomReadset(true);
	...
	public void testCreateValid() {
		...
		ReadSet readset = ReadsetFactory.getRandomReadset(false);
		readset.code = randomCode;

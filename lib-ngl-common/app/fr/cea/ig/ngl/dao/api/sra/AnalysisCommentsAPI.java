...
public class AnalysisCommentsAPI extends SubDocumentGenericAPI<Comment, AnalysisDAO, Analysis>{

	private static final String EDIT_ERROR_MESSAGE = "only user who creates the comment is allowed to modify it";
	private static final play.Logger.ALogger logger = play.Logger.of(AnalysisCommentsAPI.class);

	@Inject
	public AnalysisCommentsAPI(AnalysisDAO dao) {
		super(dao);
	}

	@Override
	public Collection<Comment> getSubObjects(Analysis objectInDB) {
		return objectInDB.comments;
	}

	@Override
	public Comment getSubObject(Analysis objectInDB, String code) {
	...
	@Override
	public Comment save(Analysis objectInDB, Comment input, String currentUser) throws APISemanticException, APIValidationException {
		if (input.code == null) {
	...
	@Override
	public Comment update(Analysis objectInDB, Comment input, String currentUser) throws APIException, APIValidationException {
		//			ContextValidation ctxVal = new ContextValidation(currentUser);

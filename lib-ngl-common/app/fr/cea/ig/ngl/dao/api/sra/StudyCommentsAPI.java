...
public class StudyCommentsAPI extends SubDocumentGenericAPI<Comment, AbstractStudyDAO, AbstractStudy>{

	private static final String EDIT_ERROR_MESSAGE = "only user who creates the comment is allowed to modify it";
	private static final play.Logger.ALogger logger = play.Logger.of(StudyCommentsAPI.class);

	@Inject
	public StudyCommentsAPI(AbstractStudyDAO dao) {
		super(dao);
	}

	@Override
	public Collection<Comment> getSubObjects(AbstractStudy objectInDB) {
		return objectInDB.comments;
	}

	@Override
	public Comment getSubObject(AbstractStudy objectInDB, String code) {
	...
	@Override
	public Iterable<AbstractStudy> listObjects(String parentCode, Query query) {
		logger.debug("listObjects: query not used");
		return Arrays.asList(dao.findByCode(parentCode));
	}

	@Override
	public Comment save(AbstractStudy objectInDB, Comment input, String currentUser) throws APISemanticException, APIValidationException {
		if (input.code == null) {
	...
	@Override
	public Comment update(AbstractStudy objectInDB, Comment input, String currentUser) throws APIException, APIValidationException {
		//			ContextValidation ctxVal = new ContextValidation(currentUser);
	...
	@Override
	public void delete(AbstractStudy objectInDB, String code, String currentUser) throws APIException {

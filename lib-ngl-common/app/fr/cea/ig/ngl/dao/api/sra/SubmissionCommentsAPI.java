...
public class SubmissionCommentsAPI extends SubDocumentGenericAPI<Comment, SubmissionDAO, Submission>{

	private static final String EDIT_ERROR_MESSAGE = "only user who creates the comment is allowed to modify it";
	private static final play.Logger.ALogger logger = play.Logger.of(SubmissionCommentsAPI.class);

	@Inject
	public SubmissionCommentsAPI(SubmissionDAO dao) {
		super(dao);
	}

	@Override
	public Collection<Comment> getSubObjects(Submission objectInDB) {
		return objectInDB.comments;
	}

	@Override
	public Comment getSubObject(Submission objectInDB, String code) {
	...
	@Override
	public Iterable<Submission> listObjects(String parentCode, Query query) {
		logger.debug("listObjects: query not used");
		return Arrays.asList(dao.findByCode(parentCode));
	}

	@Override
	public Comment save(Submission objectInDB, Comment input, String currentUser) throws APISemanticException, APIValidationException {
		if (input.code == null) {
	...
	@Override
	public Comment update(Submission objectInDB, Comment input, String currentUser) throws APIException, APIValidationException {
		//			ContextValidation ctxVal = new ContextValidation(currentUser);
	...
	@Override
	public void delete(Submission objectInDB, String code, String currentUser) throws APIException {

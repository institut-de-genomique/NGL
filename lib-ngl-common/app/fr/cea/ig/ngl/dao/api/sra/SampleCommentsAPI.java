...
public class SampleCommentsAPI extends SubDocumentGenericAPI<Comment, AbstractSampleDAO, AbstractSample>{

	private static final String EDIT_ERROR_MESSAGE = "only user who creates the comment is allowed to modify it";
	private static final play.Logger.ALogger logger = play.Logger.of(SampleCommentsAPI.class);

	@Inject
	public SampleCommentsAPI(AbstractSampleDAO dao) {
		super(dao);
	}

	@Override
	public Collection<Comment> getSubObjects(AbstractSample objectInDB) {
		return objectInDB.comments;
	}

	@Override
	public Comment getSubObject(AbstractSample objectInDB, String code) {
	...
	@Override
	public Iterable<AbstractSample> listObjects(String parentCode, Query query) {
		logger.debug("listObjects: query not used");
		return Arrays.asList(dao.findByCode(parentCode));
	}

	@Override
	public Comment save(AbstractSample objectInDB, Comment input, String currentUser) throws APISemanticException, APIValidationException {
		if (input.code == null) {
	...
	@Override
	public Comment update(AbstractSample objectInDB, Comment input, String currentUser) throws APIException, APIValidationException {
		//			ContextValidation ctxVal = new ContextValidation(currentUser);
	...
	@Override
	public void delete(AbstractSample objectInDB, String code, String currentUser) throws APIException {

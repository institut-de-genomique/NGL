...
public class CatalogsAPI extends GenericAPI<CatalogsDAO, AbstractCatalog> {
	...
	private static final ALogger LOGGER = Logger.of(CatalogsAPI.class);
	...
	private static final String CATEGORY_BOX = "Box";
	
	private static final String CATEGORY_REAGENT = "Reagent";
	
	private static final String EXPERIMENT_TYPE_CODE = "experimentTypeCodes";
	...
	public Iterable<AbstractCatalog> getByExperimentTypeCode(String experimentTypeCode) {
		return this.dao.find(
				DBQuery.and(DBQuery.is(CATEGORY, CATEGORY_KIT), DBQuery.is(EXPERIMENT_TYPE_CODE, experimentTypeCode)));
	}

	public Iterable<AbstractCatalog> getByKitCatalogCode(Collection<String> kitCatalogCodes) {
		return this.dao.find(
				DBQuery.and(DBQuery.in(CATEGORY, CATEGORY_BOX, CATEGORY_REAGENT),
						DBQuery.in(KIT_CATALOG_CODE, kitCatalogCodes)));
	}

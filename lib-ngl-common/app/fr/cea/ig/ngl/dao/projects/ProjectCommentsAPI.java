...
public class ProjectCommentsAPI extends SubDocumentGenericAPI<Comment, ProjectsDAO, Project>{

	private static final String EDIT_ERROR_MESSAGE = "only user who creates the comment is allowed to modify it";
	private static final play.Logger.ALogger logger = play.Logger.of(ProjectCommentsAPI.class);
	
	@Inject
	public ProjectCommentsAPI(ProjectsDAO dao) {
		super(dao);
	}

	@Override
	public Collection<Comment> getSubObjects(Project objectInDB) {
		return objectInDB.comments;
	}

	@Override
	public Comment getSubObject(Project objectInDB, String code) {
	...
	@Override
	public Iterable<Project> listObjects(String parentCode, Query query) {
		logger.debug("listObjects: query not used");
		return Arrays.asList(dao.findByCode(parentCode));
	}

	@Override
	public Comment save(Project objectInDB, Comment input, String currentUser) throws APISemanticException, APIValidationException {
		if (input.code == null) {
...
//		ctxVal.setCreationMode();
	...
	@Override
	public Comment update(Project objectInDB, Comment input, String currentUser) throws APIException, APIValidationException {
//		ContextValidation ctxVal = new ContextValidation(currentUser);
//		ctxVal.setUpdateMode();
	...
	@Override
	public void delete(Project objectInDB, String code, String currentUser) throws APIException {

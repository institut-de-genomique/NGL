...
public class UmbrellaProjectCommentsAPI extends SubDocumentGenericAPI<Comment, UmbrellaProjectsDAO, UmbrellaProject>{

	private static final String EDIT_ERROR_MESSAGE = "only user who creates the comment is allowed to modify it";
	private static final play.Logger.ALogger logger = play.Logger.of(UmbrellaProjectCommentsAPI.class);
	
	@Inject
	public UmbrellaProjectCommentsAPI(UmbrellaProjectsDAO dao) {
		super(dao);
	}

	@Override
	public Collection<Comment> getSubObjects(UmbrellaProject objectInDB) {
		return objectInDB.comments;
	}

	@Override
	public Comment getSubObject(UmbrellaProject objectInDB, String code) {
	...
	@Override
	public Iterable<UmbrellaProject> listObjects(String parentCode, Query query) {
		logger.debug("listObjects: query not used");
		return Arrays.asList(dao.findByCode(parentCode));
	}

	@Override
	public Comment save(UmbrellaProject objectInDB, Comment input, String currentUser) throws APISemanticException, APIValidationException {
		if (input.code == null) {
		...
		ctxVal.putObject("project", objectInDB);		
	...
	@Override
	public Comment update(UmbrellaProject objectInDB, Comment input, String currentUser) throws APIException, APIValidationException {
	...
	@Override
	public void delete(UmbrellaProject objectInDB, String code, String currentUser) throws APIException {

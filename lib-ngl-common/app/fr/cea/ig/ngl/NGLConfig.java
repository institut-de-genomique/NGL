...
public class NGLConfig {
	...
	public static final String AD_OU_USERS_NAME        = "ad.ou.users.name";
	...
	public String getActiveDirectoryOrganozationUnitUsersName()	{
		return config.getString(AD_OU_USERS_NAME);
	}

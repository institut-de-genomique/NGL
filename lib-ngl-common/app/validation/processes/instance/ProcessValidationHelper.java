...
//		ProcessType processType = BusinessValidationHelper.validateRequiredDescriptionCode(contextValidation, typeCode, "typeCode", ProcessType.find.get(),true);
		ProcessType processType = validateCodeForeignRequired(contextValidation, ProcessType.miniFind.get(), typeCode, "typeCode", true);
		if (processType != null) {
...
//		BusinessValidationHelper.validateRequiredDescriptionCode(contextValidation, categoryCode, "categoryCode", ProcessCategory.find.get(),false);
		validateCodeForeignRequired(contextValidation, ProcessCategory.miniFind.get(), categoryCode, "categoryCode");
	}
...
//		BusinessValidationHelper.validateExistDescriptionCode(contextValidation, currentExperimentTypeCode, "currentExperimentTypeCode", ExperimentType.find.get(),false);
		validateCodeForeignOptional(contextValidation, ExperimentType.miniFind.get(), currentExperimentTypeCode, "currentExperimentTypeCode");
	}
...
//		contextValidation.removeKeyFromRootKeyName("state");
	 ...
	 * (context parameter {@link #FIELD_STATE_CODE}). 
...
//		}
	...
	/**
	 * Validate a required container code (context parameter {@link #FIELD_STATE_CODE}).
...
//			// LOGIC: the true parameter is probably not needed

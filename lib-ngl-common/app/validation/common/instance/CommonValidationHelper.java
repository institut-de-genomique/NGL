...
//	public static void validateStateRequired(ContextValidation contextValidation, String typeCode, State state) {
//		if (ValidationHelper.validateNotEmpty(contextValidation, state, "state"))
//			state.validate(contextValidation.appendPath("state")
//					                        .withObject(FIELD_TYPE_CODE, typeCode));
//	}
...
//		validateRequiredInstanceCode(projectCode, "projectCode", Project.class, InstanceConstants.PROJECT_COLL_NAME, contextValidation);

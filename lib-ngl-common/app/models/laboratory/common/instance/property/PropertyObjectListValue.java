...
////					&& PropertyObjectListValue.validateProperty(contextValidation, propertyDefinition, this)				
//					&& validate(contextValidation, propertyDefinition)				
////					&& PropertyObjectListValue.convertPropertyValue(contextValidation, this, propertyDefinition)) {
//					&& convertValue(contextValidation, propertyDefinition)) {
////				PropertyObjectListValue.validatePropertyBounds(contextValidation, propertyDefinition, this);
//				validateBounds(contextValidation, propertyDefinition);
//						// TO DO FORMAT AND UNIT
//			}
//		}
//	}
	@Override
...
//	private static boolean convertPropertyValue(ContextValidation contextValidation, PropertyObjectListValue propertyValue, PropertyDefinition propertyDefinition) {
...
//	 */
//	public static boolean validateProperty(ContextValidation contextValidation, PropertyDefinition propertyDefinition, PropertyObjectListValue propertyValue) {
...
//						if (ValidationHelper.validateNotEmpty(contextValidation, value, codes[0] + ".value[" + i++ + "]." + codes[1]))
//							isValid = false;
//					}		
//					return isValid;
//				});
...
//	 */
//	public static boolean validatePropertyBounds(ContextValidation contextValidation, PropertyDefinition propertyDefinition, PropertyObjectListValue propertyValue) {

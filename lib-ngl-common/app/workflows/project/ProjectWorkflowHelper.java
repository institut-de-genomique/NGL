// Disabled, code kept for further development.
...
//	
//	@Inject
//	public ProjectWorkflowHelper(/*NGLApplication ctx,*/ MembersProjectsAPI membersAPI) {
////		this.ctx = ctx;
...
//		members.admins     = MembersProjectsUtils.convertListLogin(project.projectManagers);
//		try {

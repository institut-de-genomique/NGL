...
import fr.cea.ig.ngl.dao.projects.UmbrellaProjectCommentsAPI;
...
public class UmbrellaProjectComments extends NGLController implements NGLForms {

    private final UmbrellaProjectCommentsAPI api;
    private final UmbrellaProjectsAPI parentApi;


    @Inject
    public UmbrellaProjectComments(NGLApplication app, UmbrellaProjectCommentsAPI api, UmbrellaProjectsAPI parentApi) {
        super(app);
        this.api = api;
    ...
    public Result save(String parentCode) {
        return globalExceptionHandler(() -> {
            UmbrellaProject objectInDB = parentApi.get(parentCode);	
            if (objectInDB == null) {
                return notFound();
            } else {

...
factory('balanceSheetsGeneralSrv', ['$http', '$q', 'mainService', 'datatable', '$parse', '$filter',
		...
		var balanceSheetsGeneralService = {
			 ...
			 * @param {*} sheets 
			 */
			computeExcelExport: function(outputFile, sheets){
				$http.post(jsRoutes.controllers.balancesheets.api.BalanceSheets.excelReport().url, {sheets: sheets}, {responseType: "blob"})

...
import fr.cea.ig.ngl.dao.api.sra.ProjectCommentsAPI;
import fr.cea.ig.ngl.support.NGLForms;
import models.laboratory.common.instance.Comment;
import models.sra.submit.sra.instance.Project;
import play.mvc.Result;

public class ProjectComments extends NGLController implements NGLForms {

    private final ProjectCommentsAPI api;
    private final ProjectAPI parentApi;


    @Inject
    public ProjectComments(NGLApplication app, ProjectCommentsAPI api, ProjectAPI parentApi) {
        super(app);
        this.api = api;
    ...
    public Result save(String parentCode) {
        return globalExceptionHandler(() -> {
            Project objectInDB = parentApi.get(parentCode);	
            if (objectInDB == null) {
                return notFound();
            } else {

...
import fr.cea.ig.ngl.dao.api.sra.SampleCommentsAPI;
import fr.cea.ig.ngl.support.NGLForms;
import models.laboratory.common.instance.Comment;
import models.sra.submit.sra.instance.AbstractSample;
import play.mvc.Result;

public class SampleComments extends NGLController implements NGLForms {

    private final SampleCommentsAPI api;
    private final AbstractSampleAPI parentApi;


    @Inject
    public SampleComments(NGLApplication app, SampleCommentsAPI api, AbstractSampleAPI parentApi) {
        super(app);
        this.api = api;
    ...
    public Result save(String parentCode) {
        return globalExceptionHandler(() -> {
            AbstractSample objectInDB = parentApi.get(parentCode);	
            if (objectInDB == null) {
                return notFound();
            } else {

...
import fr.cea.ig.ngl.dao.api.sra.SubmissionCommentsAPI;
import fr.cea.ig.ngl.support.NGLForms;
import models.laboratory.common.instance.Comment;
import models.sra.submit.sra.instance.Submission;
import play.mvc.Result;

public class SubmissionComments extends NGLController implements NGLForms {

    private final SubmissionCommentsAPI api;
    private final SubmissionAPI parentApi;


    @Inject
    public SubmissionComments(NGLApplication app, SubmissionCommentsAPI api, SubmissionAPI parentApi) {
        super(app);
        this.api = api;
    ...
    public Result save(String parentCode) {
        return globalExceptionHandler(() -> {
            Submission objectInDB = parentApi.get(parentCode);	
            if (objectInDB == null) {
                return notFound();
            } else {

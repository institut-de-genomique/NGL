 ...
 * http://localhost:9000/sra/scripts/run/sra.scripts.TestSample?code=code_sample
 * @author sgas
 *
 */
public class TestSample extends Script<TestSample.MyParam>{
...
//	
	...
	public void execute(MyParam args) throws Exception {
		//args.code = "sample_BCM_4932_OS_564";
		Sample sample = sampleAPI.dao_getObject(args.code);
		...
		//validateAttributes(sample.attributes);
		sample.attributes = "";
		...
		if(contextValidation.hasErrors()) {
			...
			printfln("ok pour sample.code=%s", sample.code);				
		}
	}
}

...
//		list_abstractSample.add(abstractSampleAPI.dao_findOne(DBQuery.in("accession", "ERS1603060")));
		
		int countSample = 0;
		int countSampleAttributes = 0;
		List <Sample> problems = new ArrayList<Sample>();

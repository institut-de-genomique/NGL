...
public class CreateSraParameters extends ScriptNoArgs {
	...
	public void execute() throws Exception {
		...
		genere_sraParameter_simplifiedStates();
		delete_sraParameter_for_type("miniSimplifiedStates");
		genere_sraParameter_miniSimplifiedStates();
	...
	public void genere_sraParameter_simplifiedStates() { 
		println("Generation de simplifiedStates");	
		@SuppressWarnings("serial")
		Map<String, String> map =  new HashMap<String, String>() {
			{	
				put("pseudo-01-NONE"            , "Non associé à une soumission");
	...
	public void genere_sraParameter_miniSimplifiedStates() { 
	...
	public void genere_sraParameter_pseudoStateCodeToStateCodes() { 
	...
	public void genere_sraParameter_submissionProjectType() { 
		println("Generation du submissionProjectType");	
		@SuppressWarnings("serial")
		Map<String, String> map=  new HashMap<String, String>() {
			{
				put("sequencing_project", "SEQUENCING_PROJECT"); 
			}
		};
		int cp = 0;
		for (Iterator<Entry<String, String>> iterator = map.entrySet().iterator(); iterator.hasNext();) {
	...
	public void delete_sraParameter_for_type(String type) {
		...
		for (SraParameter sraParameter : sraParams) {
			sraParameter.deleteByCode(sraParameter.code);
		}
		println("Deletion dans table SraParameter de " + sraParams.size() + " donnees de type " + type);
	}

...
angular.module('home').controller('ActivateCtrl',[ '$http', '$scope', '$routeParams' , '$q', 'mainService', 'lists', 'tabService', 'messages', 'datatable',
...
//----------------------------------------------------------------------------------------
	...
	// message erreur correct avec 2 submiddion.code si rep_soumission existent deja

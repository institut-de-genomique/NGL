...
//----------------------------------------------------------------------------------------
	...
	var init = function(){
		...
		console.log("!!!! depart scope.isStudyCheckable=" + $scope.isStudyCheckable);
...
//			});	
	...
	function processInSubmission(decompte, error, tableau_studies, tableau_samples, tableau_experiments) { // pas d'indication de retour dans la signature.
	...
	$scope.userValidate = function("validation"){
		...
		for(var i = 0; i < tableau_studies.length ; i++){
			...
			.success(function(data){
				...
				//$scope.messages.text=Messages('submissions.msg.validate.success');
				//$scope.messages.open();
				decompte = processInSubmission(decompte, error, tableau_studies, tableau_samples, tableau_experiments);

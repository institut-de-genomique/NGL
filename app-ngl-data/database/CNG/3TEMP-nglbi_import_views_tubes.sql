...
*/
------------------VERSION INTERMEDIARE===> les tag doivent pointer sur 'short_name' et pas 'nglbi_code'
...
AS
  SELECT DISTINCT
         ...
         CASE
             ...
             ELSE NULL
         END AS tagcategory,
         ----11/09/2015 VOIR plus haut...i.nglbi_code AS tag,            -- 16/04/2015 nglbi_code remplace short_name
         e.short_name AS tag,            -- 16/04/2015 nglbi_code remplace short_name

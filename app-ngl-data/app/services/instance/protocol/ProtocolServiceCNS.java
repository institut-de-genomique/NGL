...
public class ProtocolServiceCNS {   
    ...
    public static void saveProtocols(ContextValidation ctx){        
        ...
        lp.add(newProtocol("Autre", "Autre", "path2", "1", "production", InstanceFactory.setExperimentTypeCodes("dna-illumina-indexed-library", "fragmentation","dna-extraction","dna-rna-extraction")));
...
"cDNAsynthesisType" : "value" : "..." */
        ...
        lp.add(newProtocol("zymoseq_ribofree", "ZymoSeq RiboFree", "path2", "1", "production", InstanceFactory.setExperimentTypeCodes("rna-illumina-library", "indexing-and-pcr-amplification"), concatMap(newPSV("rnaLibProtocol", "ZymoSeq RiboFree"), newPSV("strandOrientation", "reverse"), newPSV("cDNAsynthesisType", "random"))));
        lp.add(newProtocol("zymoseq_ribofree_depletion", "Déplétion ZymoSeq RiboFree", "path2", "1", "production", InstanceFactory.setExperimentTypeCodes("rrna-depletion"), concatMap(newPSV("depletionMethod", "depletion universelle"))));
        ...
        lp.add(newProtocol("ribozero_plus_depletion", "Déplétion RiboZero Plus", "path2", "1", "production", InstanceFactory.setExperimentTypeCodes("rrna-depletion"), newPSV("depletionMethod", "déplétion RiboZero Plus")));
        ...
        lp.add(newProtocol("other-rrna-depletion", "Déplétion autre", "path2", "1", "production", InstanceFactory.setExperimentTypeCodes("rrna-depletion"), newPSV("depletionMethod", "autre")));

        //NGL-2515
        lp.add(newProtocol("ribozero_human_mouse_rat", "Déplétion humain rat souris", "path2", "1", "production", InstanceFactory.setExperimentTypeCodes("rrna-depletion"), newPSV("depletionMethod", "déplétion humain rat souris")));
        ...
        //NGL-2717
        lp.add(newProtocol("bq_hi-c", "Bq Hi-C", "path1", "1", "production", InstanceFactory.setExperimentTypeCodes("dna-illumina-indexed-library", "fragmentation","pcr-amplification-and-purification"), concatMap(newPSV("libraryProtocol", "Bq Hi-C"))));
        ...
        //Protocol MGI
        lp.add(newProtocol("dnbseq-g400-high-throughput-seq","DNBSEQ-G400RS High-throughput Sequencing","path7", "1","production", InstanceFactory.setExperimentTypeCodes("mgi-sscircularisation","mgi-nanoballs"))); 
        lp.add(newProtocol("dnbseq-g400-high-throughput-rapid-seq","DNBSEQ-G400RS High-throughput (Rapid) Sequencing","path7", "1", "production", InstanceFactory.setExperimentTypeCodes("mgi-sscircularisation","mgi-nanoballs"))); 
        lp.add(newProtocol("dnbseq-g400-high-throughput-seq-v3.1-1","DNBSEQ-G400RS High Throughput Sequencing Set V3.1-1",    "path7", "1", "production", 
        		InstanceFactory.setExperimentTypeCodes("mgi-depot"))); 
        lp.add(newProtocol("DNBSEQ-G400RS High-throughput (Rapid) Sequencing","dnbseq-g400-high-throughput-rapid-seq","path7", "1", "production", 
        		InstanceFactory.setExperimentTypeCodes("mgi-prepa-fc"))); 
        lp.add(newProtocol("DNBSEQ-G400RS High-throughput Sequencing","dnbseq-g400-high-throughput-seq","path7", "1", "production", 
        		InstanceFactory.setExperimentTypeCodes("mgi-prepa-fc")));

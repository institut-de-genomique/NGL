...
public class UpdateDailyBalanceSheet extends AbstractImportData {
	...
	public void runImport(ContextValidation ctx)
		...
		for(Type type: Type.values()) {
			...
			BalanceSheet bs = MongoDBDAO.findOne(InstanceConstants.BALANCE_SHEET_COLL_NAME, BalanceSheet.class, DBQuery.and(DBQuery.is("year", currentYear), DBQuery.is("type", type.value)));
			if(bs == null) {

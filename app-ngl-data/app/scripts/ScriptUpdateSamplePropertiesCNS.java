 ...
 *
 */
public class ScriptUpdateSamplePropertiesCNS extends Script<ScriptUpdateSamplePropertiesCNS.Args>{
	...
	@Inject
	public ScriptUpdateSamplePropertiesCNS(NGLApplication app) {
		super();
		this.app=app;
	}

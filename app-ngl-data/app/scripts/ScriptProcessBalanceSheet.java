...
public class ScriptProcessBalanceSheet extends Script<ScriptProcessBalanceSheet.Args> {
	...
	public void execute(Args args) throws Exception {
		...
		BalanceSheet bs = MongoDBDAO.findOne(InstanceConstants.BALANCE_SHEET_COLL_NAME, BalanceSheet.class, DBQuery.and(DBQuery.is("year", args.year), DBQuery.is("type", args.type)));
		if(bs == null) {

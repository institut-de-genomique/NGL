...
public final class SampleFactory {
	...
	/**
	 * Méthode permettant de générer un Hashset de sample aléatoires.
	 * 
	 * @return Un Hashset de chaîne de caractères correspondant à liste de sample.
	 */
	public static HashSet<Sample> getRandomSampleHashset() {
		HashSet<Sample> list = new HashSet<>();

		for (int i = 0; i < TestUtils.LIST_SIZE; i++) {
			list.add(getRandomSample(new Date(), false));
		}
	...
	/**
	 * Méthode permettant de générer un TreeSet de code sample aléatoires.
	 * 
	 * @return Un TreeSet de chaîne de caractères correspondant à liste de code sample.
	 */
	public static TreeSet<String> getRandomSampleTreeSet() {
	...
	/**
	 * Méthode permettant de générer un Hashset de sample codes aléatoires.
	 * 

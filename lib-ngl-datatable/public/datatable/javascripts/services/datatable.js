				...
				var datatable = {
		    			...
		    			getOrderColumnClass : function(columnId){
		    				if(this.config.order.active){
			    				return new Function("config", 
									...
									"else if(config.order.columns."+columnId+" && config.order.reverse) {return 'fa fa-sort-down';}")(this.config);			    						    					    					
		    				} else{
		    					//console.log("order is not active !!!");
		    				}
		    			},
		    			...
		    			setHideColumn : function(columnId){	
		    				if(this.config.hide.active){
			    				new Function("config", "if(!config.hide.columns."+columnId+")" +
			    						"{config.hide.columns."+columnId+"=true;} else {config.hide.columns."+columnId+"=false;}")(this.config);
		    			...
		    			isHide : function(columnId){
		    				if(this.config.hide.active){
				    			return new Function("config", "if(config.hide.columns."+columnId+") return config.hide.columns."+columnId+";else return false;")(this.config);
		    				}else{
		    					//console.log("hide is not active !");
		    					return false;
		    				}

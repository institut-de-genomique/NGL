...
public class Indexes extends NGLController implements NGLJavascript {
	...
	public Result javascriptRoutes() {
		return jsRoutes(
				...
				controllers.commons.api.routes.javascript.Parameters.list(),  // pour l'instant on réutilise l'API de Parameters. TODO séparer les index des autres parametres

...
public class Qpcrlightcycler480iiAloneInput extends AbstractInput {
	...
	*/
	...
	private Experiment processMappingFile(Experiment experiment, PropertyFileValue pfv, String mode, ContextValidation contextValidation) throws Exception {
		...
		// 08/04/2020 renommer ce parametre car mode deja utilisé !!!
		...
		//  !!! noms des parameterName hardcodés !!!
		switch (mappingMode) {
		...
		if ( null == mapQPCR ){
			contextValidation.addError("Erreur interne", "io.error.resultat.notexist", "map-qpcr-parameter"); 
			return experiment;
		}

/**
 * FDS 30/10/2018 creation BASIQUE
 */
angular.module('home').controller('FrgCdnaIndexingCtrl',['$scope', '$parse', 'atmToSingleDatatable','mainService','tagPlates',
                                                    function($scope, $parse, atmToSingleDatatable, mainService, tagPlates){
	...
	//le seul instrument listé est la main, seuls les tubes sont autorises en sortie !!

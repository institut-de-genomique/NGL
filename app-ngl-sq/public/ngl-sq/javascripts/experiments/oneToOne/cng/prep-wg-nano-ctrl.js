...
angular.module('home').controller('PrepWgNanoCtrl',['$scope', '$parse',  '$filter', 'atmToSingleDatatable','$http','tagPlates',
	...
	var datatableConfig = {
			...
			// note: utiliser containerUsed seulement pour proprietes dynamiques...
			"columns":[
			...
			"save":{
	        	...
	        	"callback":function(datatable){
	        		...
	        		// plaque en inputContainer => pos='auto'
	...
	// 26/06/2018 utilisation de la factory tagPlates dans le module tools (tag-plate-helpers.js)
	$scope.plates=[];
	...
	$scope.tagPlate = $scope.plates[0]; // defaut du select plates
	
	// 26/06/2018 NGL-2014 setTags mis en commun dans tag-plate-helpers.js
	...
	$scope.selectColOrPlate = {
		...
		select:function(){
			// 26/06/2018 NGL-2014 utiliser la factory tagPlates

...
angular.module('home').controller('LibraryPrepCtrl',['$scope', '$parse',  '$filter', 'mainService','atmToSingleDatatable','$http','tagPlates','tagService',
	...
	// NOTE les indexes de la plaque RAP TruSeq RNA HT sont strictement les meme que ceux de la DAP TruSeq DNA HT => utilisation de la meme methode populateIndex_Xap
	//      idem pour les plaques IDT-ILMN TruSeq ( les concentrations sont differentes,mais pas géré ici)
	$scope.plates=[];
	$scope.plates.push( {name: "---",                                           tagCategory: undefined,   tags: undefined });
	$scope.plates.push( {name:"RAP TruSeq RNA HT (96 Indexes)",                 tagCategory:"DUAL-INDEX", tags: tagPlates.populateIndex_XapTruSeqHT() }); // 21/10/2022...pas de ticket; RAP DNA est incorrect c'est RAP RNA
	$scope.plates.push( {name:"DAP TruSeq DNA HT (96 Indexes)",                 tagCategory:"DUAL-INDEX", tags: tagPlates.populateIndex_XapTruSeqHT() }); //              il faut donc aussi proposer DAP DNA
	...
	$scope.plates.push( {name:"IDT-ILMN TruSeq RNA UD Indexes (96 Indexes)",    tagCategory:"DUAL-INDEX", tags: tagPlates.populateIndex_IdtTruSeq96() }); // NGL-2605 ajout autre nom pour la meme plaque
	...
	$scope.plates.push( {name:"IDT-ILMN TruSeq RNA UD Indexes (96 Indexes) V2", tagCategory:"DUAL-INDEX", tags: tagPlates.populateIndex_IdtTruSeq96V2() }); // ajout NGL-4038

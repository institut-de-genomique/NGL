angular.module('home').controller('MGINanoballsCtrl',['$scope', '$parse', '$filter', 'atmToSingleDatatable','lists','mainService',
			...
			columns:[ 
			         ...
			         },
					{
			         ...
			         },
			         {
					 		...
					 		"property" : "(inputContainerUsed.concentration.unit === 'ng/µl')?(inputContainerUsed.concentration.value / 330 / inputContainerUsed.size.value * 1000000):null",
					 		"type" : "number", 
				            "order" : true, 
				            "hide" : true, 
				           "format" : "2", 
	...
	$scope.updatePropertyFromUDT = function(value, col){
		if(col.property === 'inputContainerUsed.experimentProperties.inputQuantityDNB.value' || col.property === 'inputContainerUsed.experimentProperties.requiredVolume.value'){
			...
			if(inputContainer.concentration!=undefined && inputContainer.concentration!=null){
			
				if(inputContainer.concentration.unit==="fmol/µl"){	
					computeInputVolume=inputContainer.experimentProperties.inputQuantityDNB.value / inputContainer.concentration.value;
				}else if(inputContainer.concentration.unit==="ng/µl"){
					computeInputVolume=inputContainer.experimentProperties.inputQuantityDNB.value / (inputContainer.concentration.value*1000000/(330*inputContainer.size.value));
				}			

angular.module('home').controller('SpinColumnPurificationCtrl',['$scope', '$parse', 'atmToSingleDatatable',
	...
	if($scope.experiment.instrument.inContainerSupportCategoryCode!=="tube"){
		...
		datatableConfig.order.by = 'inputContainer.support.column';
	} else {
		datatableConfig.columns.push({
	...
	if($scope.experiment.instrument.inContainerSupportCategoryCode == "tube" && $scope.experiment.instrument.outContainerSupportCategoryCode == "96-well-plate"){
		$scope.messages.setError(Messages('experiments.input.error.no-tube-and-plaque'));		
	} else {

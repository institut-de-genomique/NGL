angular.module('home').controller('CNGPrepaFlowcellOrderedCtrl',['$scope', '$parse', '$http','atmToDragNDrop','mainService',
	...
	function checkFcPattern (){	
		...
		var Nv6000S4fcRegexp= /^[A-Za-z0-9]*DSX[XY2]$/; // info Illumina 25/01/2018; 19/06/2020 NGL-2989 nouveau pattern DSXY; 29/03/2021 NGL-3315 nouveau pattern DSX2
		...
		*/
			...
			setAlert("Alertes","Le Code Flowcell n'est pas du type 'NovaSeq 6000 / S4' (*DSXX ou *DSXY ou *DSX2).");
		}
	}

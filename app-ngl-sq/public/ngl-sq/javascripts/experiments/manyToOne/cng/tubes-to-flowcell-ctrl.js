	...
	*/
	...
	function checkNbLaneCompat(){
		...
		if ( instrumentTypecode === "cBot-onboard" ){
			...
			} else if ( instrumentCode.match('-MarieCurix') && outContainerSupportCategoryCode != "flowcell-2" && outContainerSupportCategoryCode != "flowcell-4"){ 
				// MarieCurix est un novaseq => fc-2pistes ou 4 pistes
				setAlert("Alertes","L'instrument Novaseq n'accepte que la flowcell 2 ou 4 pistes");
			}

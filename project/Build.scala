...
//	// parallelExecution in Global := false
  ...
  val buildOrganization      = "fr.cea.ig"
	...
	val sqVersion              = "2.6.7" + distSuffix
	val biVersion              = "2.6.0" + distSuffix

	val projectsVersion        = "2.6.0"  + distSuffix
	val reagentsVersion        = "2.4.0"  + distSuffix
	val subVersion             = "2.9.0"  + distSuffix
	// val dataVersion            = "2.0.0"  + distSuffix
	val nglAssetsVersion       = "2.0.0"  + distSuffix
	val nglDataVersion         = "2.8.0"  + distSuffix
  ...
  val ceaMongo    = "fr.cea.ig"           %% "mongodbplugin"      % "2.0.7"

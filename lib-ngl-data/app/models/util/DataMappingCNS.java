...
//	}
	public static String getSampleTypeFromLims(String tadnco,String tprco) {
		switch (tadnco) {
		case "15" : return "fosmid";
		case  "8" : return "plasmid";
		case  "2" : return "BAC";
		case  "1" : return tprco.equals("11") ? "MeTa-DNA" : "gDNA";
		case "16" : return "gDNA";
		case "19" : 
		case  "6" :
		case "14" : return "amplicon";
		case "12" : return "cDNA";
		case "11" : return "total-RNA";
		case "18" : return "sRNA";
		case "10" : return "mRNA";
		case "17" :	return "chIP";
		case "20" : return "depletedRNA";
		case "21" : return "aRNA";
		case "22" : return "DNAplug";
...
//	}
	public static String getRunTypeCodeMapping(String insCategoryCode) {
		switch (insCategoryCode) {
		case "GA I"        : return "RGAIIx";
		case "GA II"       : return "RGAIIx";
		case "GA IIx"      : return "RGAIIx";
		case "Hi2500"      : return "RHS2500";
		case "Hi2500 Fast" : return "RHS2500R";
		case "HiSeq 2000"  : return "RHS2000";
		case "MiSeq"       : return "RMISEQ";
		default            : return null;
		}
	}
...
//	}
	public static String getStateReadSetFromLims(String state, TBoolean validation) {
		switch (state) {
		case "A_traiter"     :
		case "Indefini"      : return "IW-QC";
		case "En_traitement" : return "IP-QC";
		case "Traite"        : switch (validation) { case UNSET : return "IW-VQC";
									                 case TRUE  : return "A";
									                 case FALSE : return "UA"; 
									                 default    : return null; }
		case "Non_traite"    : switch (validation) { case UNSET : return null;
			                                         case TRUE  : return "A";
									                 case FALSE : return "UA"; 
									                 default    : return null; }
		case "Sans_sequence" : return "UA";
		default              : return null;
		}
	}
...
//	}
	public static String getInstrumentTypeCodeMapping(String insCategoryCode) {
		switch (insCategoryCode) {
		case "GA I"        : return "GAIIx";
		case "GA II"       : return "GAIIx";
		case "GA IIx"      : return "GAIIx";
		case "Hi2500"      : return "HISEQ2500";
		case "Hi2500 Fast" : return "HISEQ2500";
		case "HiSeq 2000"  : return "HISEQ2000";
		case "MiSeq"       : return "MISEQ";
		default            : return null;
		}
	}
...
//	}
	public static Object getTagCategory(String tagCategory) {
		switch (tagCategory) {
		case "D"   : return "DUAL-INDEX";
		case "IND" :
		case "A"   :
		case "C"   :
		case "T"   :
		case "G"   : return "SINGLE-INDEX";
		case "NUG" : return "MID";
		default    : return null;
		}
	}

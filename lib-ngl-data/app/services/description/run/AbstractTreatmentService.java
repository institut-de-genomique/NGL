...
//		DAOHelpers.removeAll(TreatmentContext .class, TreatmentContext .find.get());
//		DAOHelpers.removeAll(TreatmentType    .class, TreatmentType    .find.get());
//		DAOHelpers.removeAll(TreatmentCategory.class, TreatmentCategory.find.get());		
		TreatmentContext .find.get().removeAll();
		TreatmentType    .find.get().removeAll();
		TreatmentCategory.find.get().removeAll();		
	...
	public static List<PropertyDefinition> getNGSRGIlluminaPropertyDefinitions() throws DAOException {
		...
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("% Perte après démultiplexage (Imaire)","seqLossPercent", LevelService.getLevels(Level.CODE.Lane, Level.CODE.Default), Double.class, false, "single"));
		...
		// EJACOBY: Pass to false in waiting of Fred development
	...
	public static List<PropertyDefinition> getNGSRGNanoporePropertyDefinitions() throws DAOException {
		...
		// EJACOBY: a valider propriétés communes nanopore ngsrg/read quality
	...
	public static List<PropertyDefinition> getContaminationPropertyDefinitions() throws DAOException{
		...
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("PCR contaminant database used","contadb",LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Pairs), String.class, false, "single"));
		return propertyDefinitions;		
	}
	...
	public static List<PropertyDefinition> getTaxonomyPropertyDefinitions() throws DAOException{
		...
		DescriptionFactory.newValues("kraken","megablast_megan","sortmerna2.1","centrifuge1.0.3.b","centrifuge1.0.3"),"single"));
	...
	public List<PropertyDefinition> getMinknowMetrichorPropertyDefinitions() throws DAOException {
		...
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Version MinKNOW","minKnowVersion", LevelService.getLevels(Level.CODE.Run, Level.CODE.ReadSet, Level.CODE.Default), String.class, false, "single","18.12.9.0"));
	...
	public static List<PropertyDefinition> getCheckFastqIndex()	{
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
			
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Kmer","kmersBilan.kmer",LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Pairs), String.class, true, "object_list"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Nom Kmer","kmersBilan.kmerName",LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Pairs), String.class, false, "object_list"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Nb. Kmer","kmersBilan.kmerNumber",LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Pairs), Integer.class, true, "object_list"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Pourcent. Kmer","kmersBilan.kmerPercent",LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Pairs), Double.class, true, "object_list"));

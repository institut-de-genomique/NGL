...
public class RunServiceCNS extends AbstractRunService {
	...
	public void saveReadSetType(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		l.add(DescriptionFactory.newReadSetType("Readset Illumina", "rsillumina", getReadSetPropertyDefinitions(),
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newReadSetType("Readset Nanopore", "rsnanopore",
				getReadSetPropertyDefinitionsNanopore(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		// NGL-2960 - Bionano - Changement de RSARGUS en rsopgen et nouveau readset
		// type.
		l.add(DescriptionFactory.newReadSetType("Dataset Opgen", "rsopgen", null,
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newReadSetType("Dataset Bionano", "rsbionano", getReadSetPropertyDefinitionsBionano(),
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		//NGL-3011
		l.add(DescriptionFactory.newReadSetType("Readset MGI", "rsmgi",null,
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
...
//		l.add(DescriptionFactory.newSimpleCategory(RunCategory.class, "Nanopore", "nanopore"));
		...
		l.add(new RunCategory("opgen", "Opgen"));
		l.add(new RunCategory("nanopore", "Nanopore"));
		// NGL-2959 : Nouvelle catégorie de RUN.
		l.add(new RunCategory("bionano", "Bionano"));
		//NGL-3011
		l.add(new RunCategory("mgi","MGI"));
	...
	public void saveRunType(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		l.add(DescriptionFactory.newRunType("HiSeq 2000", "RHS2000", 8, rcfind.findByCode("illumina"),
				getRunIlluminaPropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("HiSeq 2500", "RHS2500", 8, rcfind.findByCode("illumina"),
				getRunIlluminaPropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("HiSeq 2500 rapide", "RHS2500R", 2, rcfind.findByCode("illumina"),
				getRunIlluminaPropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("MiSeq", "RMISEQ", 1, rcfind.findByCode("illumina"),
				getRunIlluminaPropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("GA IIx", "RGAIIx", 1, rcfind.findByCode("illumina"),
				getRunIlluminaPropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("HiSeq 4000", "RHS4000", 1, rcfind.findByCode("illumina"),
				getRunIlluminaPropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("NovaSeq 6000", "RNVS6000", 2, rcfind.findByCode("illumina"),
				getRunNovaSeqPropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));

		l.add(DescriptionFactory.newRunType("Argus", "RARGUS", 1, rcfind.findByCode("opgen"), null,
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		// NGL-2959 : Description RUN Bionano
		l.add(DescriptionFactory.newRunType("Saphyr", "RSAPHYR", 2, rcfind.findByCode("bionano"),
				getRunBionanoPropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("Irys", "RIRYS", 2, rcfind.findByCode("bionano"),
				getRunBionanoPropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS))); 

		l.add(DescriptionFactory.newRunType("MinIon", "RMINION", 1, rcfind.findByCode("nanopore"),
				getRunNanoporePropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("MKI", "RMKI", 1, rcfind.findByCode("nanopore"),
				getRunNanoporePropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("MKIb", "RMKIB", 1, rcfind.findByCode("nanopore"),
				getRunNanoporePropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("MKIc", "RMKIC", 1, rcfind.findByCode("nanopore"),
				getRunNanoporePropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("PromethION ", "RPROMETHION", 1, rcfind.findByCode("nanopore"),
				getRunNanoporePropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));

		l.add(DescriptionFactory.newRunType("GridION ", "RGRIDION", 1, rcfind.findByCode("nanopore"),
				getRunNanoporePropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));

		//NGL-3011
		l.add(DescriptionFactory.newRunType("DNBSeq G400", "RDNBG400", 1, rcfind.findByCode("MGI"),
				null, DescriptionFactory.getInstitutes(Constants.CODE.CNS)));


		DAOHelpers.saveModels(RunType.class, l, errors);
	}

	private static List<PropertyDefinition> getReadSetPropertyDefinitionsBionano() throws DAOException {
	...
	private static List<PropertyDefinition> getReadSetPropertyDefinitions() throws DAOException {
		...
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("label","label",LevelService.getLevels(Level.CODE.File), String.class, true, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("md5","md5",LevelService.getLevels(Level.CODE.File), String.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("collabFileName","collabFileName",LevelService.getLevels(Level.CODE.File), String.class, false, "single"));
		...
		// NGL-2784
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Version de kit de purification", "purificationKitVersion", LevelService.getLevels(Level.CODE.Content), String.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Kit de purification", "purificationKit", LevelService.getLevels(Level.CODE.Content), String.class, false, "single"));
		
		return propertyDefinitions;
	}
	
	//NGL-2995 Ajout prop collabFileName specifique CNS 
	...
	private static List<PropertyDefinition> getRunIlluminaPropertyDefinitions() throws DAOException {
		...
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Types processus banque", "libProcessTypeCodes", LevelService.getLevels(Level.CODE.Run), String.class, false, 
				null, null, "list", null, false, null, null));
	...
	private static List<PropertyDefinition> getRunBionanoPropertyDefinitions() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
		
		propertyDefinitions.add(newPropertiesDefinition("Iteration Chip", "chipIteration",
				LevelService.getLevels(Level.CODE.Run), String.class, true, "single"));

		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Types processus banque",
				"libProcessTypeCodes", LevelService.getLevels(Level.CODE.Run), String.class, false, null, null, "list",
				null, false, null, null));

		return propertyDefinitions;
	}

	private static List<PropertyDefinition> getRunNovaSeqPropertyDefinitions() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
		propertyDefinitions.add(newPropertiesDefinition("Type lectures", "sequencingProgramType",
				LevelService.getLevels(Level.CODE.Run), String.class, false, DescriptionFactory.newValues("SR", "PE"),
				"single"));

		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Types processus banque",
				"libProcessTypeCodes", LevelService.getLevels(Level.CODE.Run), String.class, false, null, null, "list",
				null, false, null, null));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Mail Agirs envoyé ?", "sendMailAgirs",
				LevelService.getLevels(Level.CODE.Run), Boolean.class, false, null, null, "single", null, false, null,
				null));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Type flowcell", "novaseqFlowcellMode",
				LevelService.getLevels(Level.CODE.Run), String.class, false, null, null, "list", null, false, null,
				null));
		return propertyDefinitions;
	}

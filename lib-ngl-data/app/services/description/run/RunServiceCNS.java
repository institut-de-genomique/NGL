...
//		l.add(DescriptionFactory.newSimpleCategory(RunCategory.class, "Nanopore", "nanopore"));
	...
	public void saveRunType(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		l.add(DescriptionFactory.newRunType("HiSeq 2000","RHS2000", 8, rcfind.findByCode("illumina"), getRunIlluminaPropertyDefinitions(),  DescriptionFactory.getInstitutes( Constants.CODE.CNS) ));
		l.add(DescriptionFactory.newRunType("HiSeq 2500","RHS2500", 8, rcfind.findByCode("illumina"), getRunIlluminaPropertyDefinitions(),  DescriptionFactory.getInstitutes( Constants.CODE.CNS) ));
		l.add(DescriptionFactory.newRunType("HiSeq 2500 rapide","RHS2500R", 2, rcfind.findByCode("illumina"), getRunIlluminaPropertyDefinitions(),  DescriptionFactory.getInstitutes( Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("MiSeq","RMISEQ", 1, rcfind.findByCode("illumina"), getRunIlluminaPropertyDefinitions(), DescriptionFactory.getInstitutes( Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("GA IIx","RGAIIx", 1, rcfind.findByCode("illumina"), getRunIlluminaPropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("HiSeq 4000","RHS4000", 1, rcfind.findByCode("illumina"), getRunIlluminaPropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("NovaSeq 6000","RNVS6000", 2, rcfind.findByCode("illumina"), getRunNovaSeqPropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		
		l.add(DescriptionFactory.newRunType("Argus","RARGUS", 1, rcfind.findByCode("opgen"), null, DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		
		l.add(DescriptionFactory.newRunType("MinIon","RMINION", 1, rcfind.findByCode("nanopore"), getRunNanoporePropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("MKI","RMKI", 1, rcfind.findByCode("nanopore"), getRunNanoporePropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("MKIb","RMKIB", 1, rcfind.findByCode("nanopore"), getRunNanoporePropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		l.add(DescriptionFactory.newRunType("PromethION ","RPROMETHION", 1, rcfind.findByCode("nanopore"), getRunNanoporePropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
	...
	private static List<PropertyDefinition> getRunNovaSeqPropertyDefinitions() throws DAOException {
		...
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Mail Agirs envoyé ?", "sendMailAgirs", LevelService.getLevels(Level.CODE.Run), Boolean.class, false, null, null, 
				"single", null, false, null, null));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Type flowcell", "novaseqFlowcellMode", LevelService.getLevels(Level.CODE.Run), String.class, false, 
				null, null, "list", null, false, null, null));
	    return propertyDefinitions;
	}

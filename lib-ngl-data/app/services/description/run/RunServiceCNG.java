...
//		l.add(DescriptionFactory.newSimpleCategory(RunCategory.class, "Nanopore", "nanopore"));
	...
	public void saveRunType(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		//NGL-3231
		l.add(DescriptionFactory.newRunType("GridION ", "RGRIDION", 1, rcfind.findByCode("nanopore"),getRunNanoporePropertyDefinitions(), DescriptionFactory.getInstitutes(Constants.CODE.CNG)));
	...
	private static List<PropertyDefinition> getReadSetPropertyDefinitions() throws DAOException {
		...
		*/
		...
		// FDS 16/10/2019 idem ci dessus: ajouter les proprietes injectees automatiquement dans les experiences qui creent des samples en meme temp que des containers: fromProjectCode, fromSampleCode, FromSampleTypeCode

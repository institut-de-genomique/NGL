...
//			l.add(DescriptionFactory.newSimpleCategory(TreatmentCategory.class, code.name(), code.name()));
	...
	public  void saveTreatmentType(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		l.add(DescriptionFactory.newTreatmentType("NGSRG","ngsrg-illumina", tcfind.findByCode(TreatmentCategory.CODE.ngsrg.name()), "ngsrg", 
		...
		l.add(DescriptionFactory.newTreatmentType("Read Quality","read-quality", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "readQualityRaw,readQualityClean", 
		...
		l.add(DescriptionFactory.newTreatmentType("Duplicates","duplicates", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "duplicatesRaw,duplicatesClean", 
		...
		l.add(DescriptionFactory.newTreatmentType("Contamination","contamination", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "contaminationColi,contaminationVector,contaminationPhiX", 
		...
		l.add(DescriptionFactory.newTreatmentType("Check Fastq Index","check-fastq-index", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "checkFastqIndex", 
				getCheckFastqIndex(), 
				Arrays.asList(getTreatmentTypeContext("pairs", Boolean.FALSE)), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNG), "105"));	
		...
		l.add(DescriptionFactory.newTreatmentType("Taxonomy","taxonomy", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "taxonomy", 
				getTaxonomyPropertyDefinitions(), 
				Arrays.asList(getTreatmentTypeContext("read1",Boolean.FALSE), getTreatmentTypeContext("pairs", Boolean.FALSE)), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNG), "70"));
		
		//specific CNG 
		l.add(DescriptionFactory.newTreatmentType("alignSingleRead BLAT","alignsingleread-blat", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "alignSingleReadBLATRaw", 
				getASRBPropertyDefinitions(), 
				getTreatmentTypeContexts("read1", "read2"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNG), "50"));

		l.add(DescriptionFactory.newTreatmentType("alignSingleRead SOAP2","alignsingleread-soap2", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "alignSingleReadSOAP2Raw", 
				getASRSPropertyDefinitions(), 
				getTreatmentTypeContexts("read1", "read2"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNG), "60"));

		l.add(DescriptionFactory.newTreatmentType("Exome","exome", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "exome", 
		...
		l.add(DescriptionFactory.newTreatmentType("Whole Genome","whole-genome", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "wholeGenome", 
				getWholeGenomePropertyDefinitions(), 
				getTreatmentTypeContexts("pairs"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNG), "110"));
		
		l.add(DescriptionFactory.newTreatmentType("RNAseq","rna-seq", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "RNASeq", 
				getRnaSeqTreatmentPropertyDefinitions(), 
				getTreatmentTypeContexts("pairs"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNG), "120"));

		l.add(DescriptionFactory.newTreatmentType("ChiPseq","chip-seq", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "ChiPseq", 
		...
		l.add(DescriptionFactory.newTreatmentType("ChiPseq-PE","chipseq-pe", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "ChiPseqPE", 
				getChiPSeqPETreatmentPropertyDefinitions(), 
				getTreatmentTypeContexts("pairs"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNG), "140"));

		l.add(DescriptionFactory.newTreatmentType("FAIREseq","faire-seq", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "FAIREseq", 
				getFaireSeqTreatmentPropertyDefinitions(), 
				getTreatmentTypeContexts("read1"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNG), "150"));

		// GA: level parameter must be verified
		l.add(DescriptionFactory.newTreatmentType("Sample Control","sample-control", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "sampleControl", 
				getSampleControlTreatmentPropertyDefinitions(), 
				getTreatmentTypeContexts("pairs"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNG), "160"));

		l.add(DescriptionFactory.newTreatmentType("Gender", "gender", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "Gender", 
...
//	}
	...
	private static List<PropertyDefinition> getSampleControlTreatmentPropertyDefinitions() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
		// GA: Level "pairs" must be confirmed 

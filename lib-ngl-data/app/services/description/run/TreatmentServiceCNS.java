...
//			l.add(DescriptionFactory.newSimpleCategory(TreatmentCategory.class, code.name(), code.name()));
			l.add(new TreatmentCategory(code, code.name()));
	...
	public  void saveTreatmentType(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		TreatmentCategoryDAO tcfind = TreatmentCategory.find.get();
		// common CNS - CNG
		l.add(DescriptionFactory.newTreatmentType("SAV","sav", tcfind.findByCode(TreatmentCategory.CODE.sequencing.name()), "sav", 
		...
		l.add(DescriptionFactory.newTreatmentType("NGS-RG","ngsrg-illumina", tcfind.findByCode(TreatmentCategory.CODE.ngsrg.name()), "ngsrg", 
		...
		l.add(DescriptionFactory.newTreatmentType("Primary Demultiplexing","primary-demultiplexing", tcfind.findByCode(TreatmentCategory.CODE.ngsrg.name()), "primaryDemultiplexing", 
				getPrimaryDemultiplexingPropertyDefinitions(), 
				getTreatmentTypeContexts("default"), 
				DescriptionFactory.getInstitutes( Constants.CODE.CNS), "21"));		
		

		l.add(DescriptionFactory.newTreatmentType("NGS-RG","ngsrg-nanopore", tcfind.findByCode(TreatmentCategory.CODE.ngsrg.name()), "ngsrg", 
				getNGSRGNanoporePropertyDefinitions(), 
				getTreatmentTypeContexts("default"), 
				DescriptionFactory.getInstitutes( Constants.CODE.CNS), "20"));		

		l.add(DescriptionFactory.newTreatmentType("Chromium","chromium", tcfind.findByCode(TreatmentCategory.CODE.ngsrg.name()), "chromium", 
		...
		l.add(DescriptionFactory.newTreatmentType("Top Index","topIndex", tcfind.findByCode(TreatmentCategory.CODE.ngsrg.name()), "topIndex", 
		...
		l.add(DescriptionFactory.newTreatmentType("Global","global", tcfind.findByCode(TreatmentCategory.CODE.global.name()), "global", 
				getReadSetPropertyDefinitions(), 
				getTreatmentTypeContexts("default"), 
				DescriptionFactory.getInstitutes( Constants.CODE.CNS), "0"));

		l.add(DescriptionFactory.newTreatmentType("Read Quality","read-quality", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "readQualityRaw,readQualityClean,readQualityTrim", 
		...
		l.add(DescriptionFactory.newTreatmentType("Read Quality","read-quality-nanopore", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "readQuality", 
				getReadQualityNanoporePropertyDefinitions(), 
				getTreatmentTypeContexts("default"), 
				DescriptionFactory.getInstitutes( Constants.CODE.CNS), "30,83,84"));

		l.add(DescriptionFactory.newTreatmentType("Duplicates","duplicates", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "duplicatesRaw,duplicatesClean,duplicatesTrim", 
		...
		l.add(DescriptionFactory.newTreatmentType("Mapping","mapping", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "mapping", 
		...
		l.add(DescriptionFactory.newTreatmentType("Mapping Nanopore ","mapping-nanopore", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "mapping", 
				getMappingNanoporePropertyDefinitions(), 
				getTreatmentTypeContexts("default"), 
				DescriptionFactory.getInstitutes( Constants.CODE.CNS), "90"));

		l.add(DescriptionFactory.newTreatmentType("Trimming","trimming", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "trimmingStd,trimmingVector", 
				getTrimmingPropertyDefinitions(), 
				Arrays.asList(getTreatmentTypeContext("read1",Boolean.FALSE), getTreatmentTypeContext("read2", Boolean.FALSE), getTreatmentTypeContext("pairs", Boolean.FALSE), 
						getTreatmentTypeContext("single", Boolean.FALSE)), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "33,50"));
		
		l.add(DescriptionFactory.newTreatmentType("Trimming Nanopore","trimming-nanopore", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "trimming", 
				getTrimmingNanoporePropertyDefinitions(), 
				getTreatmentTypeContexts("default"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "34"));

		l.add(DescriptionFactory.newTreatmentType("First Base Report", "firstBaseReport", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "firstBaseReport",
		...
		l.add(DescriptionFactory.newTreatmentType("Contamination","contamination", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "contaminationColi,contaminationVector,contaminationPhiX,contaminationAmplicons,contaminationPCR,contaminationChicken", 
				...
				Arrays.asList(getTreatmentTypeContext("read1",Boolean.FALSE), getTreatmentTypeContext("pairs", Boolean.FALSE), 
						getTreatmentTypeContext("single", Boolean.FALSE)), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "35,36,60,61,110,120"));

		
		l.add(DescriptionFactory.newTreatmentType("Check Fastq Index","checkFastqIndex", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "checkFastqIndex", 
				getCheckFastqIndex(), 
				Arrays.asList(getTreatmentTypeContext("pairs", Boolean.FALSE)), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "100"));	
		
		l.add(DescriptionFactory.newTreatmentType("Taxonomy","taxonomy", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "taxonomy,taxonomyPcrDecontam", 
				getTaxonomyPropertyDefinitions(), 
				Arrays.asList(getTreatmentTypeContext("read1",Boolean.FALSE), getTreatmentTypeContext("pairs", Boolean.FALSE)), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "70,120"));

		//Specific CNS
		l.add(DescriptionFactory.newTreatmentType("Sorting Ribo","sorting-ribo", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "sortingRibo", 
		...
		l.add(DescriptionFactory.newTreatmentType("Merging","merging", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "merging", 
				getMergingPropertyDefinitions(), 
				getTreatmentTypeContexts("pairs"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "100"));
		
		l.add(DescriptionFactory.newTreatmentType("Clusters Db Assignation","clustersdb-assignation", tcfind.findByCode(TreatmentCategory.CODE.quality.name()), "clustersDbAssignation", 
		...
		l.add(DescriptionFactory.newTreatmentType("Merging BA","merging-ba", tcfind.findByCode(TreatmentCategory.CODE.ba.name()), "mergingBA", 
				getMergingBAPropertyDefinitions(), 
				getTreatmentTypeContexts("pairs"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "110"));

		l.add(DescriptionFactory.newTreatmentType("Assembly BA","assembly-ba", tcfind.findByCode(TreatmentCategory.CODE.ba.name()), "assemblyBA", 
				getAssemblyBAPropertyDefinitions(), 
				getTreatmentTypeContexts("pairs"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "120"));

		l.add(DescriptionFactory.newTreatmentType("Contig Filter BA","contigFilter-ba", tcfind.findByCode(TreatmentCategory.CODE.ba.name()), "contigFilterBA", 
				getContigFilterBAPropertyDefinitions(), 
				getTreatmentTypeContexts("pairs"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "125"));

		l.add(DescriptionFactory.newTreatmentType("Scaffolding BA","scaffolding-ba", tcfind.findByCode(TreatmentCategory.CODE.ba.name()), "scaffoldingBA", 
				getScaffoldingBAPropertyDefinitions(), 
				getTreatmentTypeContexts("pairs"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "130"));
		
		l.add(DescriptionFactory.newTreatmentType("Assembly Filter BA","assemblyFilter-ba", tcfind.findByCode(TreatmentCategory.CODE.ba.name()), "assemblyFilterBA", 
				getAssemblyFilterBAPropertyDefinitions(), 
				getTreatmentTypeContexts("pairs"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "135"));
		
		l.add(DescriptionFactory.newTreatmentType("Gap Closing BA","gapClosing-ba", tcfind.findByCode(TreatmentCategory.CODE.ba.name()), "gapClosingBA", 
				getGapClosingBAPropertyDefinitions(), 
				getTreatmentTypeContexts("pairs"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "140"));
		
		
		l.add(DescriptionFactory.newTreatmentType("Amplicon Assignation BA","ampliconAssignation-ba", tcfind.findByCode(TreatmentCategory.CODE.ba.name()), "ampliconAssignationBA", 
				getAssignationBAPropertyDefinitions(), 
				getTreatmentTypeContexts("read1"), 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS), "150"));

		//Nanopore
		l.add(DescriptionFactory.newTreatmentType("MinKnow-Metrichor","minknow-metrichor", tcfind.findByCode(TreatmentCategory.CODE.sequencing.name()), "minknowMetrichor", 
				getMinknowMetrichorPropertyDefinitions(), 
				getTreatmentTypeContexts("default"), 
				DescriptionFactory.getInstitutes( Constants.CODE.CNS), "20"));	
		
		l.add(DescriptionFactory.newTreatmentType("MinKnow-Basecalling","minknow-basecalling", tcfind.findByCode(TreatmentCategory.CODE.sequencing.name()), "minknowBasecalling", 
		...
		// NGL-2963
		l.add(DescriptionFactory.newTreatmentType("Map creation job id","map-creation-job-id", tcfind.findByCode(TreatmentCategory.CODE.bionanoAccess.name()), "mapCreationJobId", 
				getMapCreaJobIdPropertyDefinitions(), 
				getTreatmentTypeContexts("default"), 
				DescriptionFactory.getInstitutes( Constants.CODE.CNS), "20"));	
				
		// NGL-2964
		l.add(DescriptionFactory.newTreatmentType("Molecule Quality Report","molecule-quality-report", tcfind.findByCode(TreatmentCategory.CODE.ngsrg.name()), "moleculeQualityReport", 
				getMolQualReportPropertyDefinitions(), 
				getTreatmentTypeContexts("default"), 
				DescriptionFactory.getInstitutes( Constants.CODE.CNS), "20"));	
...
//		TreatmentContext tc = DAOHelpers.getModelByCode(TreatmentContext.class, TreatmentContext.find.get(), code);
		TreatmentContext tc = TreatmentContext.find.get().findByCode(code);
		TreatmentTypeContext ttc = new TreatmentTypeContext(tc, required);
		return ttc;	
	}
	
	public static List<PropertyDefinition> getMapCreaJobIdPropertyDefinitions() {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
		
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Map creation job id","mapCreationJobId", LevelService.getLevels(Level.CODE.Lane, Level.CODE.Default), String.class, false, "single"));
		
		return propertyDefinitions;		
	}
	
	public static List<PropertyDefinition> getMolQualReportPropertyDefinitions() {
		MeasureUnitDAO mufind = MeasureUnit.find.get();
		
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
		
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Total DNA (>= 20 kbp)","totalDnaGe20kbp", LevelService.getLevels(Level.CODE.Lane, Level.CODE.ReadSet, Level.CODE.Default), Long.class, false, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE), mufind.findByCode("Gb"), mufind.findByCode("pb"), "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("N50 (>=20kbp)","n50Ge20kbp", LevelService.getLevels(Level.CODE.Lane, Level.CODE.ReadSet, Level.CODE.Default), Long.class, false, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE), mufind.findByCode("Mb"), mufind.findByCode("pb"), "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Total DNA (>=150kbp)","totalDnaGe150kbp", LevelService.getLevels(Level.CODE.Lane, Level.CODE.ReadSet, Level.CODE.Default), Long.class, false, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE), mufind.findByCode("Gb"), mufind.findByCode("pb"), "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("N50 (>=150kbp)","n50Ge150kbp", LevelService.getLevels(Level.CODE.Lane, Level.CODE.ReadSet, Level.CODE.Default), Long.class, false, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE), mufind.findByCode("Mb"), mufind.findByCode("pb"), "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Total DNA (>=150kbp & minSites>= 9)","totalDnaGe150kbpMinSitesGe9", LevelService.getLevels(Level.CODE.Lane, Level.CODE.ReadSet, Level.CODE.Default), Long.class, false, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE), mufind.findByCode("Gb"), mufind.findByCode("pb"), "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("N50 (>=150kbp & minSites >=9)","n50Ge150kbpMinSitesGe9", LevelService.getLevels(Level.CODE.Lane, Level.CODE.ReadSet, Level.CODE.Default), Long.class, false, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE), mufind.findByCode("Mb"), mufind.findByCode("pb"), "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Enzyme","enzyme", LevelService.getLevels(Level.CODE.Lane, Level.CODE.ReadSet, Level.CODE.Default), String.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Enzyme recognition sequence","enzymeRecognitionSequence", LevelService.getLevels(Level.CODE.Lane, Level.CODE.ReadSet, Level.CODE.Default), String.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Label color","labelColor", LevelService.getLevels(Level.CODE.Lane, Level.CODE.ReadSet, Level.CODE.Default), String.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Average label density (>=150kbp) (/100 kbp)","avgLabelDensityGe150kbp", LevelService.getLevels(Level.CODE.Lane, Level.CODE.ReadSet, Level.CODE.Default), Float.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Reference","reference", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), String.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Map rate (>=150kbp)","mapRateGe150kbp", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Float.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Effective coverage","effectiveCoverage", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Float.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Molecule integrity number","moleculeIntegrityNumber", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Float.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Positive label variance (PLV)","positiveLabelVariance", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Float.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Negative label variance (NLV)","negativeLabelVariance", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Float.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("SiteSD","siteSd", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Float.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("ScalingSD","scalingSd", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Float.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("RelativeSD","relativeSd", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Float.class, false, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("SMin","sMin", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Float.class, false, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE), mufind.findByCode("Kb"), mufind.findByCode("pb"), "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Base pairs per pixel","basePairsPerPixel", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Float.class, false, "single"));
	...
	public static List<PropertyDefinition> getAssignationBAPropertyDefinitions() throws DAOException{
		...
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("% abundance control","assignationBilan.abundanceControlPercent",LevelService.getLevels(Level.CODE.Analysis, Level.CODE.Read1), Double.class, false, "object_list"));
		
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("control name","assignationBilanSum.controlName",LevelService.getLevels(Level.CODE.Analysis, Level.CODE.Read1), String.class, false, "object_list"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("% abundance cluster percent sum","assignationBilanSum.abundanceClusterPercentSum",LevelService.getLevels(Level.CODE.Analysis, Level.CODE.Read1), Double.class, false, "object_list"));
		return propertyDefinitions;		
	}

	public static List<PropertyDefinition> getPrimaryDemultiplexingPropertyDefinitions() throws DAOException{
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("% >= Q30(Imaire)","Q30", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Double.class, true, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Score qualité moyen(Imaire)","qualityScore", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Double.class, true, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Nb séquences valides(Imaire)","nbCluster", LevelService.getLevels(Level.CODE.Lane, Level.CODE.ReadSet, Level.CODE.Default), Long.class, true, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("% séquences valides/piste(Imaire)","validSeqPercent", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Double.class, true, "single"));
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("% Perte entre démultiplexage Imaire et 2ndaire","seqLossPctbetweenImaryAnd2ndaryDmplxing", LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Default), Double.class, false, "single"));

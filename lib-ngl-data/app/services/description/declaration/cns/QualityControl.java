...
public class QualityControl extends AbstractDeclaration {
	...
	protected List<ExperimentType> getExperimentTypeCommon() {
		...
		l.add(newExperimentType("Dosage fluo (éval échantillons à réception)","reception-fluo-quantification", null,20050,
				ecfind.findByCode(ExperimentCategory.CODE.qualitycontrol.name()), getPropertyDefinitionsDosageFluorometriqueEval(), 
				getInstrumentUsedTypes("qubit","fluoroskan","thermo-scientific-fluoroskan"),"OneToVoid", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS))); 
		
		l.add(newExperimentType("Dosage fluorométrique","fluo-quantification", null,20100,
				ecfind.findByCode(ExperimentCategory.CODE.qualitycontrol.name()), getPropertyDefinitionsDosageFluorometrique(), 
				getInstrumentUsedTypes("qubit","fluoroskan","thermo-scientific-fluoroskan"),"OneToVoid", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS))); 
		
		l.add(newExperimentType("Migration sur gel","gel-migration", null,20200,
				ecfind.findByCode(ExperimentCategory.CODE.qualitycontrol.name()), getPropertyDefinitionsGelMigration(), 
		...
		l.add(newExperimentType("Migration sur puce (eval ARN ou cDNA)","chip-migration-rna-evaluation", null,20300,
				ecfind.findByCode(ExperimentCategory.CODE.qualitycontrol.name()), getPropertyDefinitionsChipMigrationARNEvaluation(), 
		...
		l.add(newExperimentType("Migration sur puce (hors eval ARN)","chip-migration", null,20350,
				ecfind.findByCode(ExperimentCategory.CODE.qualitycontrol.name()), getPropertyDefinitionsChipMigration(), 
		...
		l.add(newExperimentType("PCR + gel","control-pcr-and-gel", null,20400,
				ecfind.findByCode(ExperimentCategory.CODE.qualitycontrol.name()), getPropertyDefinitionsPCRGel(), 
				getInstrumentUsedTypes("thermocycler"),"OneToVoid", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS))); 
	
		l.add(newExperimentType("Quantification qPCR","qpcr-quantification", null,20500,
				ecfind.findByCode(ExperimentCategory.CODE.qualitycontrol.name()), getPropertyDefinitionsQPCR(), 
		...
		l.add(newExperimentType("Electrophorèse en champ pulsé","pulsed-field-electrophoresis", null,20200,
				ecfind.findByCode(ExperimentCategory.CODE.qualitycontrol.name()), getPropertyDefinitionsPulsedFieldElectrophoresis(), 
		...
		l.add(newExperimentType("Spectrophotométrie UV","uv-spectrophotometry", null,22000,
				ecfind.findByCode(ExperimentCategory.CODE.qualitycontrol.name()), getPropertyDefinitionsUvQuantification(), 
				getInstrumentUsedTypes("nanodrop"),"OneToVoid", true, 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		
		l.add(newExperimentType("Qcard","qcard", null,22000,
				ecfind.findByCode(ExperimentCategory.CODE.qualitycontrol.name()), getPropertyDefinitionsQcard(), 
		...
		l.add(newExperimentType("QC Exterieur","external-qc", null,22000,
				ecfind.findByCode(ExperimentCategory.CODE.qualitycontrol.name()), getPropertyDefinitionsExternalQC(), 
	...
	protected List<ProcessType> getProcessTypeCommon() {
		...
		l.add(DescriptionFactory.newProcessType("QC puis satellites", "qc-transfert-purif", 
				pcfind.findByCode("satellites"), 1020,
				null, 
		...
		l.add(DescriptionFactory.newProcessType("Evaluation ADN à réception", "dna-sample-valuation", 
				pcfind.findByCode("sample-valuation"), 1010,
		...
		l.add(DescriptionFactory.newProcessType("Evaluation ARN à réception", "rna-sample-valuation", 
				pcfind.findByCode("sample-valuation"), 1011,
				getPropertyDefinitionsEvalAReception(), 
		...
		l.add(DescriptionFactory.newProcessType("Evaluation Amplicon à réception", "amplicon-sample-valuation", 
				pcfind.findByCode("sample-valuation"), 1012,
				getPropertyDefinitionsEvalAReception(), 
		...
		l.add(DescriptionFactory.newProcessType("Evaluation ADN HPM", "hmw-dna-sample-valuation", 
				pcfind.findByCode("sample-valuation"), 1013,
				getPropertyDefinitionsEvalAReception(), 
...
//		List<ProcessType> l = new ArrayList<ProcessType>();
	...
	protected void getExperimentTypeNodeCommon() {
		save(newExperimentTypeNode("ext-to-qc-transfert-purif", AbstractExperimentService.getExperimentTypes("ext-to-qc-transfert-purif").get(0), false, false, false, 
		...
		save(newExperimentTypeNode("ext-to-dna-sample-valuation", AbstractExperimentService.getExperimentTypes("ext-to-dna-sample-valuation").get(0), false, false, false, 
				null, getExperimentTypes("dnase-treatment","rrna-depletion"), getExperimentTypes("fluo-quantification","chip-migration"),getExperimentTypes("pool","tubes-to-plate","plate-to-tubes")));		
		save(newExperimentTypeNode("ext-to-rna-sample-valuation", AbstractExperimentService.getExperimentTypes("ext-to-rna-sample-valuation").get(0), false, false, false, 
				null, getExperimentTypes("dnase-treatment","rrna-depletion"), getExperimentTypes("fluo-quantification","chip-migration"),getExperimentTypes("pool","tubes-to-plate","plate-to-tubes")));		
		save(newExperimentTypeNode("ext-to-amplicon-sample-valuation", AbstractExperimentService.getExperimentTypes("ext-to-amplicon-sample-valuation").get(0), false, false, false, 
				null, getExperimentTypes("dnase-treatment","rrna-depletion"), getExperimentTypes("fluo-quantification","chip-migration"),getExperimentTypes("pool","tubes-to-plate","plate-to-tubes")));		
	
		save(newExperimentTypeNode("ext-to-hmw-dna-sample-valuation", AbstractExperimentService.getExperimentTypes("ext-to-hmw-dna-sample-valuation").get(0), false, false, false, 
				null, getExperimentTypes("dnase-treatment","rrna-depletion"), getExperimentTypes("fluo-quantification","chip-migration"),getExperimentTypes("pool","tubes-to-plate","plate-to-tubes")));		
		...
		save(newExperimentTypeNode("fluo-quantification",getExperimentTypes("fluo-quantification").get(0),false, false,false,
	...
	private List<ExperimentTypeNode> getETForFluoQuantification(){
		...
		pets.add(getExperimentTypeNodes("ext-to-hmw-dna-sample-valuation").get(0));
	...
	private List<PropertyDefinition> getPropertyDefinitionsExternalQC() {
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume fourni", "providedVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 11, true, null,null));
		propertyDefinitions.add(newPropertiesDefinition("Concentration fournie", "providedConcentration", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode("ng/µl"),"single", 13, true, null,null));
		propertyDefinitions.add(newPropertiesDefinition("Quantité fournie", "providedQuantity", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),mufind.findByCode( "ng"),mufind.findByCode("ng"),"single", 15, true, null,null));
		propertyDefinitions.add(newPropertiesDefinition("Taille fournie", "providedSize", LevelService.getLevels(Level.CODE.ContainerIn), Integer.class, false, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),mufind.findByCode( "pb"),mufind.findByCode("pb"),"single", 16, true, null,null));
	...
	private List<PropertyDefinition> getPropertyDefinitionsDosageFluorometrique() {
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume mesuré", "preQuantificationVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 11, false, null,null));
		...
		propertyDefinitions.add(newPropertiesDefinition("Conc. calculée en nM ", "nMcalculatedConcentration", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "nM"),mufind.findByCode("nM"),"single", 33, false, null,"2"));

		//NGL-3146 Spécifique MGI (affichage géré dans ctrleur reception-fluo-quantfication-ctrl.js)
		propertyDefinitions.add(newPropertiesDefinition("Conc. calculée en nM (ss) (fmol/µl)", "ssConvertedConcentration", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "fmol/µl"),mufind.findByCode("fmol/µl"),"single", 34, false, null,null));
		propertyDefinitions.add(newPropertiesDefinition("RATIO MGI ssCircu (qté ss / db) (%)", "sscircuMgiRatio", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, null, 				
				"single", 35, false, null, null));
	...
	private List<PropertyDefinition> getPropertyDefinitionsDosageFluorometriqueEvalCommon() {
		...
		propertyDefinitions.add(newPropertiesDefinition("Choix visuel", "displayChoice", LevelService.getLevels(Level.CODE.Experiment), String.class, false, null, 
				DescriptionFactory.newValues("Tout","HS1","HS1 (single stranded) (MGI)", "BR1 + HS1 + HS2", "HS1 + HS2 + HS3"),null,null,null,"single", 10, true, "Tout", null));
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume engagé", "inputVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 12, true, null,null));		
		
		//BR pos 13 à 16 dans datatable
		...
		propertyDefinitions.add(newPropertiesDefinition("Vol. engagé ds dosage BR", "inputVolumeBR1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 14, true, null,null));		
		propertyDefinitions.add(newPropertiesDefinition("Dosage BR (sur dilution)", "concentrationDilBR1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode("ng/µl"),"single", 15, true, null,null));
		propertyDefinitions.add(newPropertiesDefinition("Dosage BR (réel)", "concentrationBR1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode("ng/µl"),"single", 16, false, null,null));
		...
		propertyDefinitions.add(newPropertiesDefinition("Vol. engagé ds dosage HS1", "inputVolumeHS1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 18, true, null,null));	
		propertyDefinitions.add(newPropertiesDefinition("Dosage HS 1 (sur dilution)", "concentrationDilHS1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode("ng/µl"),"single", 19, true, null,null));
		propertyDefinitions.add(newPropertiesDefinition("Dosage HS 1 (réel)", "concentrationHS1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode("ng/µl"),"single", 20, false, null,"3"));
		...
		propertyDefinitions.add(newPropertiesDefinition("Vol. engagé ds dosage HS2", "inputVolumeHS2", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 22, true, null,null));	
		propertyDefinitions.add(newPropertiesDefinition("Dosage HS 2 (sur dilution)", "concentrationDilHS2", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode("ng/µl"),"single", 23, true, null,null));
		propertyDefinitions.add(newPropertiesDefinition("Dosage HS 2 (réel)", "concentrationHS2", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode("ng/µl"),"single", 24, false, null,"3"));
		...
		propertyDefinitions.add(newPropertiesDefinition("Vol. engagé ds dosage HS3", "inputVolumeHS3", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 26, true, null,null));	
		propertyDefinitions.add(newPropertiesDefinition("Dosage HS 3 (sur dilution)", "concentrationDilHS3", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode("ng/µl"),"single", 27, true, null,null));
		propertyDefinitions.add(newPropertiesDefinition("Dosage HS 3 (réel)", "concentrationHS3", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode("ng/µl"),"single", 28, false, null,"3"));
		
		//Prop communes 29 à 32
		...
		propertyDefinitions.add(newPropertiesDefinition("Concentration finale", "concentration1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode("ng/µl"),"single", 30, false, null,"3"));
		propertyDefinitions.add(newPropertiesDefinition("Volume final", "volume1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, true, "F", 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode("µL"),"single", 31, true, null,null));
		propertyDefinitions.add(newPropertiesDefinition("Quantité finale", "quantity1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),mufind.findByCode( "ng"),mufind.findByCode("ng"),"single", 32, false, null,null));
	...
	private List<PropertyDefinition> getPropertyDefinitionsGelMigration() {
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume sortie", "volume1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, true, "F", 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),
	...
	private List<PropertyDefinition> getPropertyDefinitionsPCRGel() {
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume sortie", "volume1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, true, "F", 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 14, true, null,null));
	...
	public static List<PropertyDefinition> getPropertyDefinitionsChipMigrationARNEvaluation() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume engagé", "inputVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, null, 
				MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME), mufind.findByCode( "µL"), mufind.findByCode("µL"),
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume sortie", "volume1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, true, "F", 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 17, true, null,null));
		...
		propertyDefinitions.add(newPropertiesDefinition("Concentration", "concentration1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, null, 
				MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION), mufind.findByCode( "ng/µl"), mufind.findByCode("ng/µl"),
	...
	public static List<PropertyDefinition> getPropertyDefinitionsChipMigration() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume engagé", "inputVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, null, 
				mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME), mufind.findByCode( "µL"), mufind.findByCode("µL"),
				"single", 11, true, null, "0"));		
		...
		propertyDefinitions.add(newPropertiesDefinition("Taille", "measuredSize", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, true, "F", null, 
				mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_SIZE), mufind.findByCode("pb"), mufind.findByCode("pb"),
		...
		propertyDefinitions.add(newPropertiesDefinition("Conc. calculée en nM", "nMcalculatedConcentration", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "nm"),mufind.findByCode("nm"),"single", 20, false, null,"2"));
		...
		propertyDefinitions.add(newPropertiesDefinition("Layout Nominal Length","libLayoutNominalLength", LevelService.getLevels(Level.CODE.ContainerIn, Level.CODE.Content), Integer.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_SIZE),mufind.findByCode( "pb"),mufind.findByCode( "pb"),"single", 21, false, null,null));
		...
		propertyDefinitions.add(newPropertiesDefinition("Taille insert","insertSize", LevelService.getLevels(Level.CODE.ContainerIn, Level.CODE.Content), Integer.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_SIZE),mufind.findByCode( "pb"),mufind.findByCode( "pb"),"single", 25, false, null,null));
	...
	private List<PropertyDefinition> getPropertyDefinitionsQPCR() {
		...
		propertyDefinitions.add(newPropertiesDefinition("Concentration", "concentration1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, true, "F", null, 
				MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION), mufind.findByCode( "nM"), mufind.findByCode("nM"),
	...
	private List<PropertyDefinition> getPropertyDefinitionsQcard() {
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume engagé", "inputVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 15, true, null,null));
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume sortie", "volume1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, true, "F", 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode("µL"),"single", 21, true, null,null));
	...
	private List<PropertyDefinition> getPropertyDefinitionsUvQuantification() {
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume mesuré", "preQuantificationVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 11, true, null,null));
		
		
		propertyDefinitions.add(newPropertiesDefinition("Volume engagé", "inputVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 13, true, null,null));
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume sortie", "volume1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, true, "F", 
				null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode("µL"),"single", 20, true, null,null));
	...
	private List<PropertyDefinition> getPropertyDefinitionsPulsedFieldElectrophoresis() {
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume engagé", "inputVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class,
				false, null, null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume en sortie", "volume1", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, 
				true, "F", null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),
				"single", 17, true, null,null));

...
public class Transfert extends AbstractDeclaration {
	...
	protected List<ExperimentType> getExperimentTypeCommon() {
		...
		l.add(newExperimentType("Pool Tube","pool-tube",null,10200,
				ecfind.findByCode(ExperimentCategory.CODE.transfert.name()), getPropertyDefinitionPoolTube(),
		...
		/*l.add(newExperimentType("Batch Pool","batch-pool",null,10300,
				ecfind.findByCode(ExperimentCategory.CODE.transfert.name()), getPropertyDefinitionPoolTube(),
				getInstrumentUsedTypes("tecan-evo-100", "biomek-fx", "hand"),"ManyToOne", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		
		l.add(newExperimentType("Batch Pool 2","batch-pool-two",null,10300,
				ecfind.findByCode(ExperimentCategory.CODE.transfert.name()), getPropertyDefinitionPoolTube(),
				getInstrumentUsedTypes("tecan-evo-100", "biomek-fx", "hand"),"ManyToOne", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));*/
		...
		l.add(newExperimentType("Normalisation","normalisation",null,10400,
				ecfind.findByCode(ExperimentCategory.CODE.transfert.name()), getPropertyDefinitionNormalisation(),
				getInstrumentUsedTypes("biomek-fx","brand-lhs","gilson-pipetmax","hand"),"OneToOne", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));

		l.add(newExperimentType("Dilution","dilution",null,10450,
				ecfind.findByCode(ExperimentCategory.CODE.transfert.name()), getPropertyDefinitionDilution(),
		...
		l.add(newExperimentType("Tubes / Plaques -> Plaque","x-to-plate",null,10700,
				ecfind.findByCode(ExperimentCategory.CODE.transfert.name()),  getPropertyDefinitionPlateTubeToPlate(),
				getInstrumentUsedTypes("hand","tecan-evo-100","biomek-fx"),"OneToOne", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
	...
	protected void getExperimentTypeNodeCommon() {
		save(newExperimentTypeNode("ext-to-transfert-qc-purif", AbstractExperimentService.getExperimentTypes("ext-to-transfert-qc-purif").get(0), false, false, false, 
				null, getExperimentTypes("dnase-treatment","rrna-depletion"), getExperimentTypes("aliquoting"),getExperimentTypes("fluo-quantification")));		
		...
		save(newExperimentTypeNode("tubes-to-plate",getExperimentTypes("tubes-to-plate").get(0),false, false,false,
...
//	}
	private List<ExperimentTypeNode> getETForTubeToPlaque(){
		return Arrays.asList(getExperimentTypeNodes("ext-to-transfert-qc-purif").get(0));
	}
	...
	private static List<PropertyDefinition> getPropertyDefinitionNormalisation() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition("Conc. max theorique", "maximumConcentration", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),null,null,"single", 18, false, null,null));
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume engagé", "inputVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, true, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 20, true, null,null));
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume tampon", "bufferVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, true, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 21, false, null,null));
	...
	private static List<PropertyDefinition> getPropertyDefinitionDilution() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume tampon", "bufferVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, true, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 22, false, null,null));
	...
	private static List<PropertyDefinition> getPropertyAliquoting() throws DAOException {
		...
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
		propertyDefinitions.add(newPropertiesDefinition("Volume engagé","inputVolume", LevelService.getLevels(Level.CODE.ContainerIn),Double.class, true, null
				, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"), "single",10, false));
	...
	private static List<PropertyDefinition> getPropertyDefinitionPoolTube() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume tampon", "bufferVolume", LevelService.getLevels(Level.CODE.ContainerOut), Double.class, false, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 25, true, null,null));

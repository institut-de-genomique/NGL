...
//		List<ProcessType> l =new ArrayList<ProcessType>();
	...
	*/
	...
	protected List<ExperimentType> getExperimentTypeCommon() {
		...
		l.add(newExperimentType("Réparation & End prep","nanopore-reparation-and-end-prep","FFP",2115,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()),
	...
	protected void getExperimentTypeNodeCommon() {
		...
		save(newExperimentTypeNode("nanopore-frg",
				getExperimentTypes("nanopore-frg").get(0),false, false,false,
				getExperimentTypeNodes("dna-rna-extraction","ext-to-nanopore-frg-lib-depot","ext-to-nanopore-frg-rependprep-lig-depot-process","ext-to-nanopore-frg-rep-lib-depot","ext-to-nanopore-process-library","ext-to-nanopore-process-dev","ext-to-nanopore-process-dev-2"),getExperimentTypes("nanopore-sizing"),null,
				getExperimentTypes("aliquoting","pool-tube")));	
	
		save(newExperimentTypeNode("nanopore-dna-reparation",
				getExperimentTypes("nanopore-dna-reparation").get(0),false, false,false,
				getExperimentTypeNodes("ext-to-nanopore-rep-lib-depot","nanopore-frg","nanopore-fragmentation","dna-rna-extraction","ext-to-nanopore-process-dev","ext-to-nanopore-process-dev-2","ext-to-nanopore-frg-rependprep-lig-depot-process"),null,null,
				getExperimentTypes("aliquoting","pool-tube")));
	
		save(newExperimentTypeNode("nanopore-library",
				getExperimentTypes("nanopore-library").get(0),false, false,false,
				getExperimentTypeNodes("ext-to-nanopore-process-library-no-frg","tag-pcr","dna-rna-extraction","nanopore-fragmentation", "nanopore-frg","nanopore-dna-reparation","ext-to-nanopore-process-dev"),getExperimentTypes("nanopore-sizing"),getExperimentTypes("fluo-quantification"),
				getExperimentTypes("aliquoting","pool-tube")));	
	
		save(newExperimentTypeNode("nanopore-end-prep",
				getExperimentTypes("nanopore-end-prep").get(0),false, false,false,
				null,null,null,
				null));
	
		save(newExperimentTypeNode("nanopore-reparation-and-end-prep",
				getExperimentTypes("nanopore-reparation-and-end-prep").get(0),false, false,false,
				getExperimentTypeNodes("dna-rna-extraction","nanopore-frg","ext-to-nanopore-process-dev-2","ext-to-nanopore-frg-rependprep-lig-depot-process","ext-to-nanopore-rependprep-lig-depot-process"),null,null,
				getExperimentTypes("aliquoting","pool-tube")));
		
		save(newExperimentTypeNode("nanopore-pre-pcr-ligation",
				getExperimentTypes("nanopore-pre-pcr-ligation").get(0),false, false,false,
				getExperimentTypeNodes("nanopore-end-prep","nanopore-reparation-and-end-prep"),null,null,
			null));	
				
		save(newExperimentTypeNode("nanopore-pcr",
		...
		save(newExperimentTypeNode("nanopore-barcode-ligation",
				getExperimentTypes("nanopore-barcode-ligation").get(0),false, false,false,
				getExperimentTypeNodes("nanopore-end-prep","nanopore-pcr","nanopore-reparation-and-end-prep"),null,null,
				getExperimentTypes("pool-tube")));	
	
		
		
		save(newExperimentTypeNode("nanopore-final-ligation",
				getExperimentTypes("nanopore-final-ligation").get(0),false, false,false,
				getExperimentTypeNodes("nanopore-fragmentation","nanopore-frg","nanopore-barcode-ligation","nanopore-end-prep","nanopore-pcr","nanopore-reparation-and-end-prep"),getExperimentTypes("nanopore-sizing"),null,
				getExperimentTypes("aliquoting","pool-tube")));	
		
		save(newExperimentTypeNode("nanopore-depot",
	...
	/*	propertyDefinitions.add(newPropertiesDefinition(
		...
		propertyDefinitions.add(newPropertiesDefinition(
				...
				true, "F",null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE),mufind.findByCode( "pb"),mufind.findByCode( "pb"),

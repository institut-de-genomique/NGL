...
public class Nanopore extends AbstractDeclaration{
	...
	protected List<ProcessType> getProcessTypeCommon() {
		...
		l.add(DescriptionFactory.newProcessType("Run Nanopore", "nanopore-run", 
				pcfind.findByCode("sequencing"),62 , 
				getPropertyDefinitionsNanoporeProcessRun(),
		...
		l.add(DescriptionFactory.newProcessType("Frg-rep, Lib ONT, Dépôt", "nanopore-process-library", 
				pcfind.findByCode("nanopore-library"),50, 
				getPropertyDefinitionsNanoporeProcess(), 
		...
		l.add(DescriptionFactory.newProcessType("Frg, Rep ADN, Lib, Dépôt", "nanopore-frg-rep-lib-depot", 
				pcfind.findByCode("nanopore-library"),51, 
		getPropertyDefinitionsNanoporeProcess(), 
		...
		l.add(DescriptionFactory.newProcessType("Frg (sans rep), Lib, Dépôt", "nanopore-frg-lib-depot", 
				pcfind.findByCode("nanopore-library"),52, 
				getPropertyDefinitionsNanoporeProcess(), 
		...
		l.add(DescriptionFactory.newProcessType("Rep ADN, Lib, Dépôt", "nanopore-rep-lib-depot", 
				pcfind.findByCode("nanopore-library"),53, 
				getPropertyDefinitionsNoFragNanoporeProcess(), 
		...
		l.add(DescriptionFactory.newProcessType("Lib ONT, Dépôt", "nanopore-process-library-no-frg", 
				pcfind.findByCode("nanopore-library"),54, 
				getPropertyDefinitionsNoFragNanoporeProcess(),
		...
		l.add(DescriptionFactory.newProcessType("Frg, Rep & End prep, lig, dépôt", "nanopore-frg-rependprep-lig-depot-process", 
				pcfind.findByCode("nanopore-library"),55, 
				getPropertyDefinitionsNanoporeProcess(), 
				Arrays.asList(getPET("dna-rna-extraction",-1),
						getPET("ext-to-nanopore-frg-rependprep-lig-depot-process",-1),
						getPET("nanopore-frg",0),
						getPET("nanopore-reparation-and-end-prep",1),
						getPET("nanopore-final-ligation",2),
						getPET("nanopore-depot",3)),
				getExperimentTypes("nanopore-frg").get(0),
				getExperimentTypes("nanopore-depot").get(0),
				getExperimentTypes("ext-to-nanopore-frg-rependprep-lig-depot-process").get(0),
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));

		
		l.add(DescriptionFactory.newProcessType("Rep & End prep, lig, dépôt", "nanopore-rependprep-lig-depot-process", 
				pcfind.findByCode("nanopore-library"),56, 
				getPropertyDefinitionsNoFragNanoporeProcess(), 
				Arrays.asList(getPET("dna-rna-extraction",-1),
						getPET("wga-amplification",-1),
						getPET("ext-to-nanopore-rependprep-lig-depot-process",-1),
						getPET("nanopore-reparation-and-end-prep",0),
						getPET("nanopore-final-ligation",1),
						getPET("nanopore-depot",2)),
				getExperimentTypes("nanopore-reparation-and-end-prep").get(0),
				getExperimentTypes("nanopore-depot").get(0),
				getExperimentTypes("ext-to-nanopore-rependprep-lig-depot-process").get(0),
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));

		//NGL-2515
		l.add(DescriptionFactory.newProcessType("RNAseq Nanopore", "rna-seq-nanopore-process",
				pcfind.findByCode("nanopore-library"),57,
				getPropertyDefinitionsNanoporeProcessLibrary(), 
				Arrays.asList(getPET("ext-to-rna-seq-nanopore-process",-1),
						getPET("dna-rna-extraction",-1),
						getPET("nanopore-cdna-synthesis",0),
						getPET("nanopore-final-ligation",1),
						getPET("nanopore-depot",2)),

				getExperimentTypes("nanopore-cdna-synthesis").get(0),
				getExperimentTypes("nanopore-depot").get(0),
				getExperimentTypes("ext-to-rna-seq-nanopore-process").get(0),
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));		
			 
		
		l.add(DescriptionFactory.newProcessType("Nanopore DEV", "nanopore-process-dev",
				pcfind.findByCode("nanopore-library"),60,
	                getPropertyDefinitionsNanoporeProcess(), 
		...
		l.add(DescriptionFactory.newProcessType("Nanopore DEV v2", "nanopore-process-dev-2",
				pcfind.findByCode("nanopore-library"),61,
				getPropertyDefinitionsNanoporeProcess(),
				Arrays.asList(getPET("ext-to-nanopore-process-dev-2",-1),
						...
						getPET("nanopore-cdna-synthesis",-1),
						//NGL-2990
						//getPET("tag-pcr",-1),
...
//void
		...
		l.add(newExperimentType("Ext to Process nanopore DEV", "ext-to-nanopore-process-dev",null, -1,
		 ...
		 l.add(newExperimentType("Ext to Frg, Rep & End prep, lig, dépôt","ext-to-nanopore-frg-rependprep-lig-depot-process",null, -1,
				 ecfind.findByCode(ExperimentCategory.CODE.voidprocess.name()), null,  null,"OneToOne",
	             DescriptionFactory.getInstitutes(Constants.CODE.CNS))); 
	     
		 l.add(newExperimentType("Ext to Rep & End prep, lig, dépôt","ext-to-nanopore-rependprep-lig-depot-process",null, -1,
				 ecfind.findByCode(ExperimentCategory.CODE.voidprocess.name()), null,  null,"OneToOne",
	             DescriptionFactory.getInstitutes(Constants.CODE.CNS))); 
		
		 l.add(newExperimentType("Ext to RNAseq Nanopore", "ext-to-rna-seq-nanopore-process",null, -1,
				 ecfind.findByCode(ExperimentCategory.CODE.voidprocess.name()), null,  null,"OneToOne",
	             DescriptionFactory.getInstitutes(Constants.CODE.CNS))); 
		 ...
		 l.add(newExperimentType("Purification par précipitation","precipitation-purification","PCP",2500,
					ecfind.findByCode(ExperimentCategory.CODE.purification.name()), 
					getPropertyDefinitionPrecipitationPurification(),
		...
		l.add(newExperimentType("Fragm-Réparation Nanopore","nanopore-fragmentation","FRG",2100,
		 ...
		 l.add(newExperimentType("Synthèse cDNA Nanopore","nanopore-cdna-synthesis","cDNA",2105,
					ecfind.findByCode(ExperimentCategory.CODE.transformation.name()), 
					getPropertyDefinitionsNanoporeCdnaSynthesis(),
					AbstractExperimentService.getInstrumentUsedTypes("thermocycler"),"OneToOne", 
					DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
					
		l.add(newExperimentType("Fragmentation Nanopore","nanopore-frg","FRG",2110,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()),
				getPropertyFragmentationNanopore(), 
				getInstrumentUsedTypes("megaruptor2","eppendorf-mini-spin-plus","hand"),"OneToOne", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
	
		l.add(newExperimentType("Réparation ADN","nanopore-dna-reparation","FFP",2115,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()),
				getPropertyReparationNanopore(), 
				getInstrumentUsedTypes("hand"),"OneToOne", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
	
		l.add(newExperimentType("Réparation & End prep","nanopore-reparation-and-end-prep","FFP",2120,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()),
				getPropertyRepEndPrepNanopore(), 
				getInstrumentUsedTypes("hand"),"OneToOne", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		
		l.add(newExperimentType("Librairie ONT","nanopore-library","LIB",2125,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()),
				getPropertyLibrairieNanopore(),
				getInstrumentUsedTypes("hand","voltrax"),"OneToOne", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));		
		
		l.add(newExperimentType("Depot Nanopore","nanopore-depot",null,2130,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()), 
				getPropertyDepotNanopore(),	
				getInstrumentUsedTypes("minION","mk1", "mk1b", "mk1c", "promethION", "gridION"),"OneToOne", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS) ));

		l.add(newExperimentType("End Prep","nanopore-end-prep","LIB", 2135,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()),
				getPropertyEndPrepNanopore(),
				getInstrumentUsedTypes("hand"),"OneToOne",
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));

		l.add(newExperimentType("Ligation pre-PCR","nanopore-pre-pcr-ligation","LIB", 2135,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()),
				getPropertyLigPrePcrNanopore(),
				getInstrumentUsedTypes("hand"),"OneToOne",
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));

		l.add(newExperimentType("PCR nanopore","nanopore-pcr","LIB", 2140,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()),
				getPropertyPcrNanopore(),
				getInstrumentUsedTypes("hand"),"OneToOne",
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));

		l.add(newExperimentType("Ligation barcode","nanopore-barcode-ligation","LIB", 2145,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()),
				getPropertyLigBarcodeNanopore(),
				getInstrumentUsedTypes("hand"),"OneToOne",
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		 
		l.add(newExperimentType("Ligation finale","nanopore-final-ligation","LIB", 2150,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()),
	...
	protected void getExperimentTypeNodeCommon() {
		//Nanopore
		this.save(newExperimentTypeNode("ext-to-nanopore-run", 
				getExperimentTypes("ext-to-nanopore-run").get(0), false, false, false, 
				null, null, null, 
				null));
		this.save(newExperimentTypeNode("ext-to-nanopore-process-library", 
				getExperimentTypes("ext-to-nanopore-process-library").get(0), false, false, false, 
				null, null, null, 
				null));
		this.save(newExperimentTypeNode("ext-to-nanopore-process-library-no-frg", 
				getExperimentTypes("ext-to-nanopore-process-library-no-frg").get(0), false, false, false, 
				null, null, null, 
				null));	
		
		this.save(newExperimentTypeNode("ext-to-nanopore-frg-lib-depot", 
				getExperimentTypes("ext-to-nanopore-frg-lib-depot").get(0), false, false, false, 
				null, null, null, null));
		
		this.save(newExperimentTypeNode("ext-to-nanopore-frg-rep-lib-depot",
				getExperimentTypes("ext-to-nanopore-frg-rep-lib-depot").get(0), false, false, false, 
				null, null, null, null));
		
		this.save(newExperimentTypeNode("ext-to-nanopore-rep-lib-depot", 
				getExperimentTypes("ext-to-nanopore-rep-lib-depot").get(0), false, false, false, 
				null, getExperimentTypes("nanopore-sizing"), null, null));
		
		this.save(newExperimentTypeNode("ext-to-nanopore-frg-rependprep-lig-depot-process",
				getExperimentTypes("ext-to-nanopore-frg-rependprep-lig-depot-process").get(0), false, false, false, 
				null, null, null, 
				null));	

		this.save(newExperimentTypeNode("ext-to-nanopore-rependprep-lig-depot-process",
				getExperimentTypes("ext-to-nanopore-rependprep-lig-depot-process").get(0), false, false, false, 
				null, null, null, 
				null));

		this.save(newExperimentTypeNode("ext-to-nanopore-process-dev", 
				getExperimentTypes("ext-to-nanopore-process-dev").get(0), false, false, false, 
				null, null, null, 
				null));
		
		this.save(newExperimentTypeNode("ext-to-nanopore-process-dev-2",
                getExperimentTypes("ext-to-nanopore-process-dev-2").get(0), false, false, false,
                null, null, null, 
                null));	 
		
		this.save(newExperimentTypeNode("ext-to-rna-seq-nanopore-process",
                getExperimentTypes("ext-to-rna-seq-nanopore-process").get(0), false, false, false,
                null, null, null, 
                null));	
		
		this.save(newExperimentTypeNode("nanopore-fragmentation",
				getExperimentTypes("nanopore-fragmentation").get(0),false, false,false,
				getExperimentTypeNodes("dna-rna-extraction", "ext-to-nanopore-process-library","ext-to-nanopore-process-dev","ext-to-nanopore-process-dev-2"),
				null,null,
				getExperimentTypes("aliquoting")));
		
		this.save(newExperimentTypeNode("nanopore-frg",
				getExperimentTypes("nanopore-frg").get(0),false, false,false,
				getExperimentTypeNodes("dna-rna-extraction","ext-to-nanopore-frg-lib-depot","ext-to-nanopore-frg-rependprep-lig-depot-process","ext-to-nanopore-frg-rep-lib-depot","ext-to-nanopore-process-library","ext-to-nanopore-process-dev","ext-to-nanopore-process-dev-2"),
				getExperimentTypes("nanopore-sizing"),
				null,
				getExperimentTypes("aliquoting","pool-tube")));	
	
		this.save(newExperimentTypeNode("nanopore-dna-reparation",
				getExperimentTypes("nanopore-dna-reparation").get(0),false, false,false,
				getExperimentTypeNodes("ext-to-nanopore-rep-lib-depot","nanopore-frg","nanopore-fragmentation","dna-rna-extraction","ext-to-nanopore-process-dev","ext-to-nanopore-process-dev-2","ext-to-nanopore-frg-rependprep-lig-depot-process"),
				null,
				null,
				getExperimentTypes("aliquoting","pool-tube")));
		
		//NGL-2515
		this.save(newExperimentTypeNode("nanopore-cdna-synthesis",
				getExperimentTypes("nanopore-cdna-synthesis").get(0),true, true,false, 
				getExperimentTypeNodes("dna-rna-extraction","ext-to-rna-seq-nanopore-process"),
				getExperimentTypes("nanopore-sizing"), 
				getExperimentTypes("fluo-quantification","chip-migration"),
				getExperimentTypes("pool","tubes-to-plate","plate-to-tubes")));
				

		this.save(newExperimentTypeNode("nanopore-library",
				getExperimentTypes("nanopore-library").get(0),false, false,false,
				getExperimentTypeNodes("ext-to-nanopore-process-library-no-frg","tag-pcr","dna-rna-extraction","nanopore-fragmentation", "nanopore-frg","nanopore-dna-reparation","ext-to-nanopore-process-dev"),
				getExperimentTypes("nanopore-sizing"),
				getExperimentTypes("fluo-quantification"),
				getExperimentTypes("aliquoting","pool-tube")));	
	
		this.save(newExperimentTypeNode("nanopore-end-prep",
				getExperimentTypes("nanopore-end-prep").get(0),false, false,false,
				getExperimentTypeNodes("nanopore-cdna-synthesis"),
				null,
				null,
				null));
	
		this.save(newExperimentTypeNode("nanopore-reparation-and-end-prep",
				getExperimentTypes("nanopore-reparation-and-end-prep").get(0),false, false,false,
				getExperimentTypeNodes("nanopore-cdna-synthesis","cdna-synthesis","dna-rna-extraction","nanopore-frg","ext-to-nanopore-process-dev-2","ext-to-nanopore-frg-rependprep-lig-depot-process","ext-to-nanopore-rependprep-lig-depot-process","wga-amplification"),
				null,
				null,
				getExperimentTypes("aliquoting","pool-tube")));
		
		this.save(newExperimentTypeNode("nanopore-pre-pcr-ligation",
				getExperimentTypes("nanopore-pre-pcr-ligation").get(0),false, false,false,
				getExperimentTypeNodes("nanopore-end-prep","nanopore-reparation-and-end-prep"),
				null,
				null,
				null));	
				
		this.save(newExperimentTypeNode("nanopore-pcr",
				getExperimentTypes("nanopore-pcr").get(0),false, false,false,
				getExperimentTypeNodes("nanopore-pre-pcr-ligation","nanopore-fragmentation","nanopore-frg"),
				null,
				null,
				getExperimentTypes("pool-tube")));			
				 
		this.save(newExperimentTypeNode("nanopore-barcode-ligation",
				getExperimentTypes("nanopore-barcode-ligation").get(0),false, false,false,
				getExperimentTypeNodes("nanopore-end-prep","nanopore-pcr","nanopore-reparation-and-end-prep"),
				null,
				null,
				getExperimentTypes("pool-tube")));			
		
		this.save(newExperimentTypeNode("nanopore-final-ligation",
				getExperimentTypes("nanopore-final-ligation").get(0),false, false,false,
				getExperimentTypeNodes("nanopore-cdna-synthesis","nanopore-fragmentation","nanopore-frg","nanopore-barcode-ligation","nanopore-end-prep","nanopore-pcr","nanopore-reparation-and-end-prep"),
				getExperimentTypes("nanopore-sizing"),
				null,
				getExperimentTypes("aliquoting","pool-tube")));	
		
		this.save(newExperimentTypeNode("nanopore-depot",
				getExperimentTypes("nanopore-depot").get(0),false, false,false,
				getExperimentTypeNodes("nanopore-library","ext-to-nanopore-run","ext-to-nanopore-process-dev","nanopore-final-ligation"),
				null,
				null,
				null));
		
		//Mise a jour du noeud ici car pas poss d'ajouter les bons previous au moment de la création.
		ExperimentTypeNode etn = getExperimentTypeNodes("nanopore-end-prep").get(0);
	    etn.previousExperimentTypeNodes=getExperimentTypeNodes("ext-to-nanopore-process-dev-2","nanopore-fragmentation", "nanopore-frg","nanopore-dna-reparation","nanopore-pcr","dna-rna-extraction");
	    //Just update previousExperimentNode 
	    // etn.update();
	    ExperimentTypeNode.find.get().update(etn);
	...
	private static List<PropertyDefinition> getPropertyFragmentationNanoporeOld() throws DAOException {
		...
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Qté totale dans frg","inputFrgQuantity",LevelService.getLevels(Level.CODE.ContainerIn,Level.CODE.Content), Double.class, true,  null
				, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),mufind.findByCode("ng"),mufind.findByCode( "ng"), "single",12));
		...
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Conc. finale FRG","postFrgConcentration",LevelService.getLevels(Level.CODE.ContainerOut), Double.class, false, null
				, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode( "ng/µl"), "single",13));
		...
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Qté finale FRG","postFrgQuantity",LevelService.getLevels(Level.CODE.ContainerOut,Level.CODE.Content), Double.class, false, null
				, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),mufind.findByCode( "ng"),mufind.findByCode( "ng"), "single",14));
		/*
		...
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("Taille réelle","measuredLibrarySize",LevelService.getLevels(Level.CODE.ContainerOut,Level.CODE.Content), Integer.class, false, null
				, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE),mufind.findByCode( "pb"),mufind.findByCode( "pb"), "single",16));
	...
	private static List<PropertyDefinition> getPropertyFragmentationNanopore() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition(
				...
				true,  null,null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),mufind.findByCode("ng"),mufind.findByCode( "ng"),
				"single",12,true,null,null));
		propertyDefinitions.add(newPropertiesDefinition(
				"Volume engagé","inputVolume", LevelService.getLevels(Level.CODE.ContainerIn),Double.class,
				true, null,null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"), "single",
				10,true, null, null));
	...
	/*	propertyDefinitions.add(newPropertiesDefinition(
		...
		propertyDefinitions.add(newPropertiesDefinition(
				...
				false, "F",null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE),mufind.findByCode( "pb"),mufind.findByCode( "pb"),
		...
		propertyDefinitions.add(newPropertiesDefinition(
				...
				false, null,null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),mufind.findByCode("ng"),mufind.findByCode( "ng"),
	...
	private static List<PropertyDefinition> getPropertyReparationNanopore() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition(
		 ...
		 propertyDefinitions.add(newPropertiesDefinition("Concentration","outputConcentration",LevelService.getLevels(Level.CODE.ContainerOut), Double.class,
					true, "F",null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode( "ng/µl"),
	...
	private static List<PropertyDefinition> getPropertyRepEndPrepNanopore() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
		//Containers
		propertyDefinitions.add(newPropertiesDefinition(
				"Volume engagé","inputVolume", LevelService.getLevels(Level.CODE.ContainerIn),Double.class,
				true, null,null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),MeasureUnit.find.get().findByCode( "µL"),MeasureUnit.find.get().findByCode( "µL"), "single",
				10,true, null, null));
	...
	private static List<PropertyDefinition> getPropertyDefinitionPrecipitationPurification()
	{
		MeasureUnitDAO     mufind = MeasureUnit.find.get();
		...
		propertyDefinitions.add(newPropertiesDefinition(
				"Volume engagé","inputVolume", LevelService.getLevels(Level.CODE.ContainerIn),Double.class,
				false, null,null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"), "single",
				10,true, null, null));
		propertyDefinitions.add(newPropertiesDefinition(
				"Quantité engagée","inputQuantity",LevelService.getLevels(Level.CODE.ContainerIn),Double.class,
				false, null,null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),MeasureUnit.find.get().findByCode( "ng"),MeasureUnit.find.get().findByCode( "ng"), 
				"single",11,true, null, null));		
		propertyDefinitions.add(newPropertiesDefinition(
				"Profil","migrationProfile", LevelService.getLevels(Level.CODE.ContainerOut),Image.class,
				 false, null,null,"img",55,true,null,null));	
		return propertyDefinitions;
	}
	...
	private static List<PropertyDefinition> getPropertySizingNanopore() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition(
		 ...
		 propertyDefinitions.add(newPropertiesDefinition(
				"Nombre de pistes","nbOfGelLanes",LevelService.getLevels(Level.CODE.ContainerIn), String.class,
				false, null ,null, "single",10,true,null,null));
		 ...
		 propertyDefinitions.add(newPropertiesDefinition(
					...
					false, null,null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE),mufind.findByCode( "pb"),mufind.findByCode( "pb"),
		 ...
		 propertyDefinitions.add(newPropertiesDefinition("Conc. ligation (ap. sizing)","ligationConcentrationPostSizing",LevelService.getLevels(Level.CODE.ContainerOut,Level.CODE.Content), Double.class,
				false, null,null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode( "ng/µl"),
	...
	private static List<PropertyDefinition> getPropertyDepotNanopore() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition(
				...
				true, "N", null,  MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),mufind.findByCode( "ng"),mufind.findByCode( "ng"),
		...
		propertyDefinitions.add(newPropertiesDefinition(
				...
				false,null,null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_TIME),mufind.findByCode( "h"),mufind.findByCode( "h"),
		...
		propertyDefinitions.add(newPropertiesDefinition(
				...
				false, null, null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),
...
//	}
	...
	private static List<PropertyDefinition> getPropertyLibrairieNanopore() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition(
				...
				false, null,null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),mufind.findByCode( "ng"),mufind.findByCode( "ng"), "single",
				11,true, null, null));
		propertyDefinitions.add(newPropertiesDefinition(
				"Tag","tag", LevelService.getLevels(Level.CODE.ContainerOut,Level.CODE.Content),String.class,
				false,null, getTagNanopore(),"single",13,true,null,null));
		//NGL-2330 : une propriété non obligatoire doit être éditable pour l'affichage générique des expériences (sinon la valeur est vide dans le tableau)
		propertyDefinitions.add(newPropertiesDefinition(
				"Catégorie tag","tagCategory", LevelService.getLevels(Level.CODE.ContainerOut,Level.CODE.Content),String.class,
				false, null, getTagCategoriesNanopore(), "single",14,true,"SINGLE-INDEX",null));
		propertyDefinitions.add(newPropertiesDefinition(
				"Conc. finale End Repair","postEndRepairConcentration", LevelService.getLevels(Level.CODE.ContainerOut),Double.class,
				false, null,null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode( "ng/µl"),
		...
		propertyDefinitions.add(newPropertiesDefinition(
				...
				false, null,null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),mufind.findByCode( "ng"),mufind.findByCode( "ng"),
		...
		propertyDefinitions.add(newPropertiesDefinition(
				...
				true, null, null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode( "ng/µl"), 
				"single",50,true, null, null));
		propertyDefinitions.add(newPropertiesDefinition(
				"Qté finale Ligation","ligationQuantity", LevelService.getLevels(Level.CODE.ContainerOut,Level.CODE.Content),Double.class,
				true, null, null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),mufind.findByCode( "ng"),mufind.findByCode( "ng"),
				"single",60,false, null, null)); 
	...
	private static List<PropertyDefinition> getPropertyDefinitionsNanoporeCdnaSynthesis() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
		MeasureCategoryDAO mcfind = MeasureCategory.find.get();
		MeasureUnitDAO     mufind = MeasureUnit.find.get();

		//une propriété non obligatoire doit être éditable pour l'affichage générique des expériences (sinon la valeur est vide dans le tableau)
		...
		propertyDefinitions.add(newPropertiesDefinition(
				...
				10,true, null, null));
		propertyDefinitions.add(newPropertiesDefinition(
				"Qté engagée","inputQuantity", LevelService.getLevels(Level.CODE.ContainerIn, Level.CODE.Content),Double.class,
				false, null,null, mcfind.findByCode(MeasureService.MEASURE_CAT_CODE_QUANTITY),mufind.findByCode( "ng"),mufind.findByCode( "ng"), "single",
				11,true, null, null));

		propertyDefinitions.add(newPropertiesDefinition(
				"Nb cycles PCR", "nbCycles", LevelService.getLevels(Level.CODE.ContainerOut), Integer.class,
				false, null, null,"single", 30, true, null,null));
		propertyDefinitions.add(newPropertiesDefinition(
				"Catégorie tag","tagCategory", LevelService.getLevels(Level.CODE.ContainerOut,Level.CODE.Content),String.class,
				false, null, getTagCategoriesNanopore(), "single",40,true,"SINGLE-INDEX",null));
		propertyDefinitions.add(newPropertiesDefinition(
				"Tag","tag", LevelService.getLevels(Level.CODE.ContainerOut,Level.CODE.Content),String.class,
				false,null, getTagNanopore(),"single",39,true,null,null));
...
//	}
	...
	private static List<PropertyDefinition> getPropertyPcrNanopore(){
		...
		propertyDefinitions.add(newPropertiesDefinition(
				"Nb cycles PCR", "nbCycles", LevelService.getLevels(Level.CODE.ContainerOut), Integer.class,
				true, null, null,"single", 50, true, null,null));
		propertyDefinitions.add(newPropertiesDefinition(
				"Tag","tag", LevelService.getLevels(Level.CODE.ContainerOut,Level.CODE.Content),String.class,
				false,null, getTagNanopore(),"single",13,true,null,null));
		propertyDefinitions.add(newPropertiesDefinition(
	...
	private static List<PropertyDefinition> getPropertyLigFinaleNanopore() {
		...
		propertyDefinitions.add(newPropertiesDefinition(
				"Tampon ligation","ligationBuffer", LevelService.getLevels(Level.CODE.ContainerOut),String.class,
				false,null, DescriptionFactory.newValues("LFB","SFB","autre"), "single",49,true,null,null));	
		...
		propertyDefinitions.add(newPropertiesDefinition("Conc. finale ligation","ligationConcentration",LevelService.getLevels(Level.CODE.ContainerOut,Level.CODE.Content), Double.class,
				true, null,null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_CONCENTRATION),mufind.findByCode( "ng/µl"),mufind.findByCode( "ng/µl"),
	...
	public static List<PropertyDefinition> getPropertyDefinitionsNanoporeProcess() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();		

		propertyDefinitions.addAll(getPropertyDefinitionsNanoporeProcessFragmentation());
		propertyDefinitions.addAll(getPropertyDefinitionsNanoporeProcessLibrary());
		propertyDefinitions.addAll(getPropertyDefinitionsNanoporeProcessRun());

		return propertyDefinitions;
	}
	
	public static List<PropertyDefinition> getPropertyDefinitionsNoFragNanoporeProcess() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();		
	...
	public static List<PropertyDefinition> getPropertyDefinitionsNanoporeProcessFragmentation() throws DAOException {
		MeasureUnitDAO     mufind = MeasureUnit.find.get();
		
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();		
		propertyDefinitions.add(newPropertiesDefinition(
				"Taille banque souhaitée","librarySize",LevelService.getLevels(Level.CODE.Process, Level.CODE.Content),Integer.class,
				false,null, null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE),mufind.findByCode( "kb"),mufind.findByCode( "kb"),
				"single",2,true,null,null));
		return propertyDefinitions;
	}


	public static List<PropertyDefinition> getPropertyDefinitionsNanoporeProcessLibrary() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
	...
	public static List<PropertyDefinition> getPropertyDefinitionsNanoporeProcessRun() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
	...
	public static List<Value> getLibProcessTypeCodeValues(){
		List<Value> values = new ArrayList<>();

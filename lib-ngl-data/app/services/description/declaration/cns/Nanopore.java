...
//		List<ProcessType> l =new ArrayList<ProcessType>();
	...
	*/
	...
	/*	propertyDefinitions.add(newPropertiesDefinition(
		...
		//NGL-2464 : mettre cette propriété en  NON obligatoire dans le même type d'expérience, MÊME fonctionnement que dans lib ont : ne proposer QUE les index nanopore.
		/* Suppression temporaire pour MEP 2.6.5 car pas validée 
		 *  propertyDefinitions.add(newPropertiesDefinition(
...
//	}
	...
	public static List<PropertyDefinition> getPropertyDefinitionsNanoporeProcessFragmentation() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition(
				...
				true,null, null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_SIZE),mufind.findByCode( "kb"),mufind.findByCode( "kb"),

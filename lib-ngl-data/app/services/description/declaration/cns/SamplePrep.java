...
public class SamplePrep extends AbstractDeclaration{
	...
	protected List<ExperimentType> getExperimentTypeCommon() {
		...
		l.add(newExperimentType("Extraction ADN / ARN","dna-rna-extraction","AN",700,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()), getPropertyDefinitionsExtractionADNARN(),
		...
		l.add(newExperimentType("Extraction ADN","dna-extraction","ADN",705,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()), getPropertyDefinitionsExtractionADN(),
		...
		l.add(newExperimentType("Ext to Séparation ARN (17-200 et >200nt) à partir d'ARN total","ext-to-small-and-large-isolation-process",null,-1,
				ecfind.findByCode(ExperimentCategory.CODE.voidprocess.name()), null, null,"OneToOne", 
				DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		
		l.add(newExperimentType("Extraction ARN total","total-rna-extraction","RNA",710,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()), getPropertyDefinitionsExtractionARNtotal(),
		...
		l.add(newExperimentType("Séparation ARN 17-200 et > 200nt","small-and-large-rna-isolation","RNA",720,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()), getPropertyDefinitionsExtractionARNSmallLarge(),
		...
		l.add(newExperimentType("Amplification / WGA (ou WTA)","wga-amplification","WGA",730,
				ecfind.findByCode(ExperimentCategory.CODE.transformation.name()), getPropertyDefinitionsWGAAmplification(),
	...
	protected List<ProcessType> getProcessTypeCommon() {
		...
		l.add(DescriptionFactory.newProcessType("Extraction ADN / ARN (plancton ou à partir d'aliquot corail poisson)", "dna-rna-extraction-process", 
				pcfind.findByCode("sample-prep"), 1,
				null, 
				Arrays.asList(
		...
		l.add(DescriptionFactory.newProcessType("Extraction ADN / ARN (corail et poisson)", "grinding-and-dna-rna-extraction", 
				pcfind.findByCode("sample-prep"), 2,
				null, 
				Arrays.asList(
		...
		l.add(DescriptionFactory.newProcessType("Extraction ADN (corail CDIV)", "grinding-and-dna-extraction", 
				pcfind.findByCode("sample-prep"), 3,
				null, 
				Arrays.asList(
		...
		l.add(DescriptionFactory.newProcessType("Extraction ADN (à partir aliquot corail CDIV)", "dna-extraction-process", 
				pcfind.findByCode("sample-prep"), 4,
				null, 
				Arrays.asList(
		...
		l.add(DescriptionFactory.newProcessType("Extraction ARN (17-200 et >200nt) à partir de filtres", "small-and-large-rna-extraction", 
				pcfind.findByCode("sample-prep"), 5,
				null, 
				Arrays.asList(
		...
		l.add(DescriptionFactory.newProcessType("Séparation ARN (17-200 et >200nt) à partir d'ARN total", "small-and-large-isolation-process", 
				pcfind.findByCode("sample-prep"), 6,
				null, 
				Arrays.asList(
						...
						getExperimentTypes("small-and-large-rna-isolation").get(0), getExperimentTypes("small-and-large-rna-isolation").get(0), getExperimentTypes("ext-to-small-and-large-isolation-process").get(0), 
						DescriptionFactory.getInstitutes(Constants.CODE.CNS)));

		l.add(DescriptionFactory.newProcessType("WGA (ou WTA)", "wga-or-wta-process", 
				pcfind.findByCode("sample-prep"), 7,
				null, 
				Arrays.asList(
	...
	protected void getExperimentTypeNodeCommon() {
		//Sample Preparation 
		save(newExperimentTypeNode("ext-to-grinding-and-dna-rna-extraction", getExperimentTypes("ext-to-grinding-and-dna-rna-extraction").get(0), false, false, false, null, null, null, null));
		save(newExperimentTypeNode("ext-to-grinding-and-dna-extraction", getExperimentTypes("ext-to-grinding-and-dna-extraction").get(0), false, false, false, null, null, null, null));
			
		save(newExperimentTypeNode("ext-to-dna-rna-extraction-process", getExperimentTypes("ext-to-dna-rna-extraction-process").get(0), false, false, false, null, null, null, null));
		save(newExperimentTypeNode("ext-to-small-and-large-rna-extraction", getExperimentTypes("ext-to-small-and-large-rna-extraction").get(0), false, false, false, null, null, null, null));
		save(newExperimentTypeNode("ext-to-small-and-large-isolation-process", getExperimentTypes("ext-to-small-and-large-isolation-process").get(0), false, false, false, null, null, null, null));
		save(newExperimentTypeNode("ext-to-dna-extraction-process", getExperimentTypes("ext-to-dna-extraction-process").get(0), false, false, false, null, null, null, null));

		save(newExperimentTypeNode("grinding",getExperimentTypes("grinding").get(0),false, false,false,getExperimentTypeNodes("ext-to-grinding-and-dna-rna-extraction","ext-to-grinding-and-dna-extraction"),null,null,null));
		save(newExperimentTypeNode("dna-rna-extraction",getExperimentTypes("dna-rna-extraction").get(0),false, false,false,getExperimentTypeNodes("ext-to-dna-rna-extraction-process","grinding","ext-to-grinding-and-dna-rna-extraction"),
				getExperimentTypes("dnase-treatment"),getExperimentTypes("fluo-quantification","chip-migration","gel-migration","control-pcr-and-gel"),getExperimentTypes("aliquoting")));
		save(newExperimentTypeNode("dna-extraction",getExperimentTypes("dna-extraction").get(0),false, true,true,getExperimentTypeNodes("ext-to-dna-extraction-process","grinding"),
				null,getExperimentTypes("fluo-quantification","chip-migration","gel-migration","control-pcr-and-gel"),getExperimentTypes("aliquoting")));

		save(newExperimentTypeNode("total-rna-extraction",getExperimentTypes("total-rna-extraction").get(0),false, false,false,getExperimentTypeNodes("ext-to-small-and-large-rna-extraction"),
				getExperimentTypes("dnase-treatment"),getExperimentTypes("fluo-quantification","chip-migration"),null));
		save(newExperimentTypeNode("small-and-large-rna-isolation", getExperimentTypes("small-and-large-rna-isolation").get(0), false, false, false, getExperimentTypeNodes("dna-rna-extraction","total-rna-extraction","ext-to-small-and-large-isolation-process"), 
				getExperimentTypes("dnase-treatment"),getExperimentTypes("fluo-quantification","chip-migration"), null));

		save(newExperimentTypeNode("ext-to-wga-or-wta-process", getExperimentTypes("ext-to-wga-or-wta-process").get(0), false, false, false, null, null, null, null));
		save(newExperimentTypeNode("wga-amplification", getExperimentTypes("wga-amplification").get(0), false, false, false, getExperimentTypeNodes("ext-to-wga-or-wta-process","dna-rna-extraction"), 
				getExperimentTypes("dnase-treatment"),getExperimentTypes("fluo-quantification","chip-migration"),getExperimentTypes("aliquoting")));
	}
	...
	private List<PropertyDefinition> getPropertyDefinitionsExtractionADN() {
		...
		propertyDefinitions.add(newPropertiesDefinition("Volume engagé", "inputVolume", LevelService.getLevels(Level.CODE.ContainerIn), Double.class, false, null, 
				null, MeasureCategory.find.get().findByCode(MeasureService.MEASURE_CAT_CODE_VOLUME),mufind.findByCode( "µL"),mufind.findByCode( "µL"),"single", 8, true, null,null));

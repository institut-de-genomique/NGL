...
public class BanqueIllumina extends AbstractDeclaration {
	...
	protected List<ProcessType> getProcessTypeCommon() {
		...
		l.add(DescriptionFactory.newProcessType("Ampli, Spri select, STK, Dépôt", "ampli-spri-select-stk-illumina-depot", 
				pcfind.findByCode("library"), 47,
				getAmpliSpriSelectDepotProcessProperties(),
				Arrays.asList(getPET("ext-to-ampli-spri-select-stk-illumina-depot",-1)
						,getPET("dna-illumina-indexed-library",-1)
						,getPET("pcr-amplification-and-purification",0)
	...
	private List<PropertyDefinition> getDNALibIlluminaProcessProperties() {
		...
		libProcessTypeCodes.addAll(BanqueIllumina.getLibProcessDJ());
		libProcessTypeCodes.addAll(MetaBarCoding.getBanqueProcessTypeMetaTA());
	...
	public static  List<Value> getLibProcessDJ() {
		List<Value> values = new ArrayList<>();
		values.add(DescriptionFactory.newValue("DJ", "DJ - NEBNext Genotyping avec UMI"));
		return values;
	}
	...
	private List<PropertyDefinition> getAmpureSTKDepotProcessProperties() {
		...
		libProcessTypeCodes.addAll(MetaTProcess.getBanqueProcessTypeMetaTRNA());
	...
	private List<ExperimentTypeNode> _getExperimentTypeNodeCommon() {
		ArrayList<ExperimentTypeNode> l = new ArrayList<>();
		l.add(newExperimentTypeNode("ext-to-dna-illumina-indexed-library-process", getExperimentTypes("ext-to-dna-illumina-indexed-library-process").get(0), false, false, false, null, null, null, null));
		l.add(newExperimentTypeNode("ext-to-dna-illumina-indexed-lib-sizing-process", getExperimentTypes("ext-to-dna-illumina-indexed-lib-sizing-process").get(0), false, false, false, null, null, null, null));

		l.add(newExperimentTypeNode("ext-to-ampli-stk-illumina-depot", getExperimentTypes("ext-to-ampli-stk-illumina-depot").get(0), false, false, false, null, null, null, null));
		l.add(newExperimentTypeNode("ext-to-ampli-sizing-stk-illumina-depot", getExperimentTypes("ext-to-ampli-sizing-stk-illumina-depot").get(0), false, false, false, null, null, null, null));
		l.add(newExperimentTypeNode("ext-to-sizing-stk-illumina-depot", getExperimentTypes("ext-to-sizing-stk-illumina-depot").get(0), false, false, false, null, null, null, null));
		l.add(newExperimentTypeNode("ext-to-ampure-sizing-stk-illumina-depot", getExperimentTypes("ext-to-ampure-sizing-stk-illumina-depot").get(0), false, false, false, null, null, null, null));


		l.add(newExperimentTypeNode("ext-to-ampure-stk-illumina-depot", getExperimentTypes("ext-to-ampure-stk-illumina-depot").get(0), false, false, false, null, null, null, null));
		l.add(newExperimentTypeNode("ext-to-dna-illumina-indexed-lib-spri-select-process", getExperimentTypes("ext-to-dna-illumina-indexed-lib-spri-select-process").get(0), false, false, false, null, null, null, null));
		l.add(newExperimentTypeNode("ext-to-ampli-spri-select-stk-illumina-depot", getExperimentTypes("ext-to-ampli-spri-select-stk-illumina-depot").get(0), false, false, false, null, null, null, null));
		l.add(newExperimentTypeNode("ext-to-spri-select-stk-illumina-depot", getExperimentTypes("ext-to-spri-select-stk-illumina-depot").get(0), false, false, false, null, null, null, null));
		return l;
	}
...
//		newExperimentTypeNode("ext-to-spri-select-stk-illumina-depot", getExperimentTypes("ext-to-spri-select-stk-illumina-depot").get(0), false, false, false, null, null, null, null).save();
		List<ExperimentTypeNode> l = _getExperimentTypeNodeCommon();
		for (ExperimentTypeNode n : l)

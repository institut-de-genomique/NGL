...
public class MeasureService {
	...
	public void saveMesureUnits(Map<String,List<ValidationError>> errors) throws DAOException {
		...
		l.add(newMeasureUnit("cells/µl","cells/µl",  false, mcfind.findByCode(MEASURE_CAT_CODE_CONCENTRATION))); // ajouté 20/10/2020 NGL-3141
		
		l.add(newMeasureUnit("pb",     "pb",     true,  mcfind.findByCode(MEASURE_CAT_CODE_SIZE)));
		l.add(newMeasureUnit("Gb",     "Gb",     false, mcfind.findByCode(MEASURE_CAT_CODE_SIZE)));// "Gb" ajouté pour BIONANO.
		...
		l.add(newMeasureUnit("nt",     "nt",     false, mcfind.findByCode(MEASURE_CAT_CODE_SIZE)));// nt ajouté pour MGI

...
public class ImportServiceCNS extends AbstractImportService {
	...
	public List<ImportType> getImportTypes() {
		...
		l.add(newImportType("Reception Tara Pacific", "reception-tara-pacific", icfind.findByCode("sample-import"), getTaraReceptionPropertyDefinitions(), CNS));
		l.add(newImportType("Update Tara Pacific",    "update-tara-pacific",    icfind.findByCode("sample-import"), getTaraUpdatePropertyDefinitions(), CNS));
	...
	private static List<PropertyDefinition> commonDNAReceptionPropertyDefinitions() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition("Méthode préparation ADN (ou ARN)",    "dnaTreatment", 				LevelService.getLevels(Level.CODE.Sample,Level.CODE.Content),  String.class,  false, 	null,		   DescriptionFactory.newValues("MDA",
				"plug"), 						null, 							  										null, 							  null,                              "single", 			18, 		  true, 	null,		  null));
		return propertyDefinitions;
	}
	...
	private static List<PropertyDefinition> getBiologicalSamplePropertyDefinitions() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition("Date de réception",              "receptionDate",        LevelService.getLevels(Level.CODE.Container),                  Date.class,    true,  null, null,                   "single", 1, false, null, null));
		propertyDefinitions.add(newPropertiesDefinition("META",                           "meta",                 LevelService.getLevels(Level.CODE.Sample, Level.CODE.Content), Boolean.class, true,  null, null,                   "single", 2, true,  null, null));
		propertyDefinitions.add(newPropertiesDefinition("Nom scientifique collaborateur", "collabScientificName", LevelService.getLevels(Level.CODE.Sample,Level.CODE.Content),  String.class,  false, null, null, null, null, null, "single", 5, false, null, null));
		...
		List<Value> depthOrLayerValues = newValues("0.1 cm",
				"0-1 cm",
				"1-2 cm",
				"1-3 cm",
				"2-3 cm",
	...
	private static List<PropertyDefinition> getDeNovoBiologicalSamplePropertyDefinitions() throws DAOException {
		...
		propertyDefinitions.add(newPropertiesDefinition("Date de réception", "receptionDate", LevelService.getLevels(Level.CODE.Container), Date.class, true, null, null, "single", 1, false, null, null));
		propertyDefinitions.add(newPropertiesDefinition("META", "meta", LevelService.getLevels(Level.CODE.Sample,Level.CODE.Content), Boolean.class, true, null, null, "single", 2, true, null, null));
		propertyDefinitions.add(newPropertiesDefinition("Nom scientifique collaborateur", "collabScientificName", LevelService.getLevels(Level.CODE.Sample,Level.CODE.Content), String.class, true, null, 
	...
	private static List<Value> getTargetedRegion() {
		return DescriptionFactory.newValues("16S_V4V5", "18S_V9", "16S_Full Length + 16S_V4V5", "ITS2", "CP23S",
				"18S_V4", "COI", "16S_V1V2V3", "16S_V3V4", "16S_V5V6", "18S_V1V2", "16S_V4", "5.8S","16SFL", "18S_V7V8","18SFL");
	}
	/*

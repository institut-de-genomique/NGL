...
//		l.add(newImportCategory("Sample Import", "sample-import"));
	...
	private static List<Value> getLibProcessTypeCodeValues(){
        List<Value> values = new ArrayList<>();
         ...
         // liste pour l'import depuis ancien LIMS CNGRH Solexa... a mettre a jour tant que ce dernier est supposer fonctionner ???
	...
	// ajouter aussi a l'identique dans ProcessServiceCNG  et ci-dessus getLibProcessTypeCodeValues

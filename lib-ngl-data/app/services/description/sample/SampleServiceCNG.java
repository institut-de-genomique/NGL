...
public class SampleServiceCNG extends AbstractSampleService {
	...
	public List<SampleCategory> getSampleCategories() {
		...
		l.add(new SampleCategory("biological-samples", "Prélèvements biologiques"));	// FDS ajout 11/09/2019 NGL-2607
	...
	public List<SampleType> getSampleTypes() {
		List<Institute> CNG = DescriptionFactory.getInstitutes(Constants.CODE.CNG); // 28/03/2018 faire comme au CNS...
		...
		l.add(makeSampleType("Cellules", 		"cells",		"biological-samples",null,		CNG));   // FDS ajout 11/09/2019 NGL-2607
		
		//used only in  NGL-BI. Please do not use in sample import !!!!!!!!!!!!!!!

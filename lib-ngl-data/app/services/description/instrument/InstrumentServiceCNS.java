...
//		l.add(newInstrumentCategory("Appareil de Prep. Librairie Nanopore","nanopore-library-prep-device"));
	...
	public List<InstrumentUsedType> getInstrumentUsedTypes() {
		...
		*/
		...
		l.add(newInstrumentUsedType("Blue pippin", "blue-pippin", icfind.findByCode("sizing-system"), getBluePippinProperties(), 
		...
		*/
		...
		l.add(newInstrumentUsedType("Tapestation", "tapestation", icfind.findByCode("chip-electrophoresis"), getTapestationProperties(), 
				getInstruments(
		...
		l.add(newInstrumentUsedType("Megaruptor 2", "megaruptor2", icfind.findByCode("hydroshear"), getNanoporeMegaruptor2Properties(),  getInstrumentMegaruptor2()
				,getContainerSupportCategories(new String[]{"tube"}), getContainerSupportCategories(new String[]{"tube"}), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		...
		l.add(newInstrumentUsedType("Mk1", "mk1", icfind.findByCode("nanopore-sequencer"), getNanoporeSequencerProperties(),getInstrumentMKI() 
				,getContainerSupportCategories(new String[]{"tube"}), getContainerSupportCategories(new String[]{"flowcell-1"}), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		
		l.add(newInstrumentUsedType("Mk1B", "mk1b", icfind.findByCode("nanopore-sequencer"), getMKIBSequencerProperties(),getInstrumentMKIB() 
				,getContainerSupportCategories(new String[]{"tube"}), getContainerSupportCategories(new String[]{"flowcell-1"}), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		...
		l.add(newInstrumentUsedType("IRYS", "IRYS", icfind.findByCode("opt-map-bionano"), getIrysDepotProperties(),getInstrumentIRYS() 
				,getContainerSupportCategories(new String[]{"irys-chip-2"}), null, DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		
		l.add(newInstrumentUsedType("SAPHYR", "SAPHYR", icfind.findByCode("opt-map-bionano"), getIrysDepotProperties(),getInstrumentSAPHYR() 
				,getContainerSupportCategories(new String[]{"saphyr-chip"}), null, DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		
		l.add(newInstrumentUsedType("Main", "irys-hand", icfind.findByCode("hand"), getIrysChipProperties(),getInstrumentBionanoHand() 
		...
		l.add(newInstrumentUsedType("Cryobroyeur", "cryobroyeur", icfind.findByCode("sample-prep-system"),  getCryobroyeurProperties(),getInstrumentCryobroyeur() 
		...
		l.add(newInstrumentUsedType("Fast Prep", "fast-prep", icfind.findByCode("sample-prep-system"),  getFastPrepProperties(),getInstrumentFastPrep() 
				,getContainerSupportCategories(new String[]{"tube","bottle","bag"}), getContainerSupportCategories(new String[]{"tube"}), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
		...
		l.add(newInstrumentUsedType("Nanodrop", "nanodrop", icfind.findByCode("spectrophotometer"),  null,getInstrumentNanodrop() 
				,getContainerSupportCategories(new String[]{"tube"}), getContainerSupportCategories(new String[]{"tube"}), DescriptionFactory.getInstitutes(Constants.CODE.CNS)));
...
//	}
	...
	private static List<Instrument> getInstrumentPromethION () throws DAOException {
		...
		instruments.add(createInstrument("PCT0037", "PCT0037", null, true, "/env/ig/atelier/nanopore/cnrgh/PCT0037/PCT0037/", DescriptionFactory.getInstitutes(Constants.CODE.CNS)));

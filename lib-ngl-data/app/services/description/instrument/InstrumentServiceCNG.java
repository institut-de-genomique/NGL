...
public class InstrumentServiceCNG extends AbstractInstrumentService {
	...
	public List<InstrumentUsedType> getInstrumentUsedTypes() {
		...
		l.add(newInstrumentUsedType("qPCR (Lightcycler 480 II)", "qpcr-lightcycler-480II", icfind.findByCode("qPCR-system"),
				null, //getLightCyclerProperties(), NGL-2928; voir getQpcrMappingProperties
		...
		//FDS 20/01/2021 NGL-3198: Ajout fluorometer Fluoroskan
		l.add(newInstrumentUsedType("Fluoroskan", "fluoroskan", icfind.findByCode("fluorometer"),
				getFluoroskanProperties(),
				getInstrumentsFluoroskan(CNG),
				getContainerSupportCategories(new String[]{"96-well-plate"}),
				null,// pas de sortie pour les instruments * quality *
				CNG));
		
		//FDS 20/01/2021 NGL-3198: Ajout fluorometer Fluoroskan combiné au Bravo
		l.add(newInstrumentUsedType("Bravo Workstation + Fluoroskan", "bravows-and-fluoroskan", icfind.findByCode("fluorometer"),
				getFluoroskanProperties(),
				getInstrumentsBravoAndFluoroskan(CNG),
				getContainerSupportCategories(new String[]{"96-well-plate"}),
				null,// pas de sortie pour les instruments * quality *
				CNG));
		...
		//NGL-3231 Ajout en urgence nouveau type d'instrument
		l.add(newInstrumentUsedType("GridION", "gridION", icfind.findByCode("nanopore-sequencer"), 
				getGridIONProperties(), 
				getInstrumentGridION(CNG) ,
				getContainerSupportCategories(new String[]{"tube"}), 
				getContainerSupportCategories(new String[]{"flowcell-1"}), 
				CNG));
	...
	// FDS 25/02/2021 cette liste était pour le promethion 48 flowcells (PCT0037)
	private static List<Value> getPromethionPosition48() {
	...
	// FDS 25/02/2021 NGL-3265 : pour le promethion 24 flowcells (P24-084) les positions sont differentes
	// FDS 09/04/2021 NGL-3339: les specs étaient incorrectes : les positions sont inverséés c'est pas A1 mais 1A etc...
	private static List<Value> getPromethionPosition24() {
		List<Value> values = new ArrayList<>();
	...
	// FDS 25/02/2021 faire une liste qui compile les 2 listes 24 + 48 ???
	private static List<Value> getPromethionPosition() {
		List<Value> values = new ArrayList<>();
		values.addAll(getPromethionPosition24());
		values.addAll(getPromethionPosition48());
	...
	//    07/04/2020 NGL-2928 c'est une erreur de mettre cette propriété sur le lightcycler; elle ne s'applique que pour 
	//               le mapping qpcr effectué avec l'instrument mixte!! ==> renommage en getQpcrMappingProperties()
	private static List<PropertyDefinition> getQpcrMappingProperties() throws DAOException {
		List<PropertyDefinition> l = new ArrayList<>();
	...
	*/
	...
	private static List<PropertyDefinition> getTecanEvo150AndLightCyclerProperties() throws DAOException {
		...
		// FDS NGL-2928 propriété  "sector plaque" n'est pas spécifique au LightCycler 480 II
		l.addAll( getQpcrMappingProperties());
	...
	// FDS 20/01/2021 NGL-3198
	private static List<PropertyDefinition> getFluoroskanProperties()throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
		
		propertyDefinitions.add(newPropertiesDefinition("Secteur Plaque 96","sector96", LevelService.getLevels(Level.CODE.Instrument),String.class, true, null,
				newValues("A1-H6","A7-H12"), null, null , null,  // "A1-H6","A7-H12" plus parlant que "1-48","49-96"  !!!!
				"single", null, false ,null, null));
	...
	// 25/10/2018 séparation
	private static List<Instrument> getInstrumentsCbot( List<Institute> CNG ) throws DAOException {
		List<Instrument> instruments=new ArrayList<>();
		
		// NGL-2583 19/06/2019  désactiver et les remettre dans l'association avec l'exp prepa-flowcell
	...
	private static List<Instrument> getInstrumentsCbotV2( List<Institute> CNG ) throws DAOException {
		...
		instruments.add(createInstrument("cBotA", "cBotA", null, false, null, CNG)); // NGL-3274 01/03/2021 retiré => désactivé
		instruments.add(createInstrument("cBotB", "cBotB", null, false, null, CNG)); // NGL-3274 01/03/2021 retiré => désactivé
		instruments.add(createInstrument("cBotC", "cBotC", null, false, null, CNG)); // NGL-3274 01/03/2021 retiré => désactivé
	...
	private static List<Instrument> getInstrumentsCbotOnboard( List<Institute> CNG ) throws DAOException {
		...
		instruments.add(createInstrument("cBot-Hi9-A",   "cBot-interne-Hi9-A",    null, false, null, CNG)); // NGL-3295 20/03/2021 désactivation définitive
		instruments.add(createInstrument("cBot-Hi9-B",   "cBot-interne-Hi9-B",    null, false, null, CNG)); // NGL-3295 20/03/2021 désactivation définitive
		instruments.add(createInstrument("cBot-Hi10-A",  "cBot-interne-Hi10-A",   null, false, null, CNG)); // NGL-3295 20/03/2021 désactivation définitive
		instruments.add(createInstrument("cBot-Hi10-B",  "cBot-interne-Hi10-B",   null, false, null, CNG)); // NGL-3295 20/03/2021 désactivation définitive
		instruments.add(createInstrument("cBot-Hi11-A",  "cBot-interne-Hi11-A",   null, false, null, CNG)); // NGL-3295 20/03/2021 désactivation définitive
		instruments.add(createInstrument("cBot-Hi11-B",  "cBot-interne-Hi11-B",   null, false, null, CNG)); // NGL-3295 20/03/2021 désactivation définitive
		...
		instruments.add(createInstrument("cBot-BossaNova-A","cBot-interne-BossaNova-A",null, true, null, CNG)); // NGL-2785 02/01/2020 ajout; NGL-3096 activer
		instruments.add(createInstrument("cBot-BossaNova-B","cBot-interne-BossaNova-B",null, true, null, CNG)); // NGL-2785 02/01/2020 ajout; NGL-3096 activer
	...
	private static List<Instrument> getInstrumentsMiSeq( List<Institute> CNG ) throws DAOException {
		...
		instruments.add(createInstrument("MISEQ2", "MISEQ2", "M2", false, "/env/ig/atelier/illumina/cnrgh/MISEQ2/", CNG)); // inactif parceque sert au QC ???
	...
	private static List<Instrument> getInstrumentsMiSeqQC( List<Institute> CNG ) throws DAOException {
		...
		instruments.add(createInstrument("MISEQ1-QC", "MISEQ1 QC", null, false, "/env/ig/atelier/illumina/cnrgh/MISEQ1/", CNG)); // inactif parceque ne sert pas au QC actuelement ???
	...
	public static List<Instrument> getInstrumentsHiseq2500 (List<Institute> CNG ) throws DAOException{
		...
		instruments.add(createInstrument("HISEQ9",  "HISEQ9",  "H1", false, "/env/ig/atelier/illumina/cnrgh/HISEQ9/",  CNG));// 18/09/2020 NGL-3096 plus actif
		instruments.add(createInstrument("HISEQ10", "HISEQ10", "H2", false, "/env/ig/atelier/illumina/cnrgh/HISEQ10/", CNG));// 18/09/2020 NGL-3096 plus actif
		instruments.add(createInstrument("HISEQ11", "HISEQ11", "H3", false,  "/env/ig/atelier/illumina/cnrgh/HISEQ11/", CNG));// 18/03/2021 NGL-3295 désactivation définitive
	...
	private static List<Instrument> getInstrumentGridION (List<Institute> CNG) throws DAOException {
		return Arrays.asList(
				//Instrument CNS
				createInstrument("OSIRIS", "OSIRIS", null, true, "/env/ig/atelier/nanopore/cns/OSIRIS", DescriptionFactory.getInstitutes(Constants.CODE.CNG))
				);
	...
	private static List<Instrument> getInstrumentsPromethION( List<Institute> CNG ) throws DAOException {
		...
		instruments.add(createInstrument("PCT0037", "PCT0037", null, true, "/env/ig/atelier/nanopore/cnrgh/PCT0037", CNG)); // SUPSQ-4191 modification path
		instruments.add(createInstrument("P24S084", "P24S084", null, true, "/env/ig/atelier/nanopore/cnrgh/P24S084", CNG)); // FDS ajout 05/03/2021 NGL-3265(reouverture)
		return instruments;
	}
	...
	private static List<Instrument> getInstrumentsNovaseq6000( List<Institute> CNG ) throws DAOException {
		...
		// FDS 01/07/2019 modification par l'équipe système des path ( suppression /ig/ +  cng->cnrgh )
		//	   04/09/2019 modification NGL-2662: remettre ig  pour rester coherent
		...
		instruments.add(createInstrument("BOSSANOVA",  "BOSSANOVA",  "V3", true, "/env/ig/atelier/illumina/cnrgh/BOSSANOVA/",   CNG)); // FDS 02/01/2020 NGL-2752 ajout; NGL-3096 activation par
	...
	private static List<Instrument> getInstrumentsJanusAndCbotV2( List<Institute> CNG ) throws DAOException {
		...
		instruments.add(createInstrument("janus1-and-cBotA", "Janus 1 / cBotA", null, false, null, CNG)); // NGL-3274 01/03/2021 cBotA retiré => désactivé
		instruments.add(createInstrument("janus1-and-cBotB", "Janus 1 / cBotB", null, false, null, CNG)); // NGL-3274 01/03/2021 cBotB retiré => désactivé
		instruments.add(createInstrument("janus1-and-cBotC", "Janus 1 / cBotC", null, false, null, CNG)); // NGL-3274 01/03/2021 cBotC retiré => désactivé
		...
		instruments.add(createInstrument("janus2-and-cBotA", "Janus 2 / cBotA", null, false, null, CNG)); // NGL-3274 01/03/2021 cBotA retiré => désactivé
		instruments.add(createInstrument("janus2-and-cBotB", "Janus 2 / cBotB", null, false, null, CNG)); // NGL-3274 01/03/2021 cBotB retiré => désactivé
		instruments.add(createInstrument("janus2-and-cBotC", "Janus 2 / cBotC", null, false, null, CNG)); // NGL-3274 01/03/2021 cBotC retiré => désactivé
	...
	// FDS 20/01/2021 NGL-3198
	private static List<Instrument> getInstrumentsFluoroskan( List<Institute> CNG ) throws DAOException {
		List<Instrument> instruments=new ArrayList<>();
		
		instruments.add(createInstrument("fluoroskan1", "Fluoroskan 1", null, true, null, CNG));
		
		return instruments;
	}

	// FDS 20/01/2021 NGL-3198
	private static List<Instrument> getInstrumentsBravoAndFluoroskan( List<Institute> CNG ) throws DAOException {
		List<Instrument> instruments=new ArrayList<>();
		
		instruments.add(createInstrument("bravows1-and-fluoroskan1", "Bravo Workstation 1 / Fluoroskan 1", null, true, null, CNG));

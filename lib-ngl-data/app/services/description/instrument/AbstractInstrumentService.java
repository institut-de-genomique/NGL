...
public abstract class AbstractInstrumentService {
	...
	public void main(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		logger.debug("begin deletion of all InstrumentUsedType");
//		DAOHelpers.removeAll(InstrumentUsedType.class, InstrumentUsedType.find.get());
		InstrumentUsedType.find.get().removeAll();
		logger.debug("completed deletion of all InstrumentUsedType");
		
		logger.debug("begin deletion of all InstrumentCategory");
//		DAOHelpers.removeAll(InstrumentCategory.class, InstrumentCategory.find.get());
		InstrumentCategory.find.get().removeAll();
		logger.debug("completed deletion of all InstrumentCategory");
...
//		return DAOHelpers.getModelByCodes(ContainerSupportCategory.class,ContainerSupportCategory.find.get(), codes);
		return ContainerSupportCategory.find.get().findByCodes(codes);
	}

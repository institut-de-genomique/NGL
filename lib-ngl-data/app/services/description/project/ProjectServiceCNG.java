...
//		l.add(DescriptionFactory.newSimpleCategory(ProjectCategory.class,"defaut", "default"));
	...
	private static List<PropertyDefinition> getProjectPropertyDefinitions() throws DAOException {
		...
		pds.add(DescriptionFactory.newPropertiesDefinition("Id archive", "archives.archiveNetbackupId", LevelService.getLevels(Level.CODE.Project), String.class, false,"object_list"));
		pds.add(DescriptionFactory.newPropertiesDefinition("Date archive", "archives.date", LevelService.getLevels(Level.CODE.Project), Date.class, false,"object_list"));

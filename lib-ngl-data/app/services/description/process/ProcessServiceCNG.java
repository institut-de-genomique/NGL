...
public class ProcessServiceCNG  extends AbstractProcessService {
	...
	public void saveProcessCategories(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		l.add(DescriptionFactory.newProcessCategory("Prep. Lib. pour séquençage Illumina", "library"));          // 27/09/2017 fdsantos NGL-1201 renommage label
		l.add(DescriptionFactory.newProcessCategory("Prep. Lib. pour séquençage Nanopore", "nanopore-library")); // 27/09/2017 fdsantos NGL-1201 renommage label
		l.add(DescriptionFactory.newProcessCategory("Normalisation puis séquençage", "normalization")); //02/07/2020 fdsantos NGL-3005 renommage label
		l.add(DescriptionFactory.newProcessCategory("Séquençage", "sequencing"));
		...
		l.add(DescriptionFactory.newProcessCategory("Exp satellites", "satellites"));
	...
	public void saveProcessTypes(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		List<Institute> CNG = DescriptionFactory.getInstitutes(Constants.CODE.CNG);
		...
		l.add(DescriptionFactory.newProcessType("WG PCR free (FC ordonnée)", "x5-wg-pcr-free", pcfind.findByCode("library"),
				1,
		...
		l.add(DescriptionFactory.newProcessType("WG NANO (FC ordonnée)", "x5-wg-nano", pcfind.findByCode("library"),
				2, 
		...
		// FDS ajout 31/05/2016 NGL-1025: processus long type "library"; 18/01/2017 NGL-1259 renommer code en rna-lib-process
		// FDS 03/12/2020 NGL-3172 allongement du processus jusqu'au dépot ; modif du nom ajout: (jusqu'au séquençage)
		//                !! 2 branches => même expérience finale avec 2 ordres differents
		l.add(DescriptionFactory.newProcessType("Prep lib RNAseq (jusqu'au séquençage)", "rna-lib-process", pcfind.findByCode("library"),
				...
				Arrays.asList(
						...
						getPET("normalization-and-pooling",2),
						getPET("lib-normalization",2),
						getPET("denat-dil-lib",3),    // ajout NGL-3172
						getPET("prepa-flowcell",4),   // ajout NGL-3172
						getPET("prepa-fc-ordered",3), // ajout NGL-3172
						getPET("illumina-depot",4),   // ajout NGL-3172
						getPET("illumina-depot",5) ), // ajout NGL-3172
				getExperimentTypes("library-prep").get(0),           //first experiment type
				getExperimentTypes("illumina-depot").get(0),         //last experiment type; modif pour NGL-3172
		...
		// FDS modif 13/06/2017 NGL-1473: allongement du processus-> illumina depot (renommage ..FC ordonnée)
		// FDS modif 20/10/2020 NGL-3141: chgt label supression "WG"
		// FDS modif 15/12/2020 NGL-3142: chgt label supression "(FC ordonnée)"; modif des experiences
		l.add(DescriptionFactory.newProcessType("Prep Chromium", "wg-chromium-lib-process", pcfind.findByCode("library"),
				4,
		...
		l.add(DescriptionFactory.newProcessType("Prep. Capture prod. (4000 / X5 / NovaSeq)", "capture-prep-process-fc-ord", pcfind.findByCode("library"),
				5,
		...
		l.add(DescriptionFactory.newProcessType("Prep. Capture prod. (2500 / NextSeq)", "capture-prep-process-fc", pcfind.findByCode("library"),
				6,
				getPropertyDefinitionsCapture(), 
				Arrays.asList(
		...
		// FDS 14/12/2017 NGL-1730 : renommage label (ajout NovaSeq)
		l.add(DescriptionFactory.newProcessType("Prep. Capture reprise (1) (4000 / X5 / NovaSeq)", "pcr-capture-pcr-indexing-fc-ord", pcfind.findByCode("library"),
				7,
		...
		// FDS 14/12/2017 NGL-1730 : renommage label (suppression 2000 : ne sont plus en fonction)
		l.add(DescriptionFactory.newProcessType("Prep. Capture reprise (1) (2500 / NextSeq)", "pcr-capture-pcr-indexing-fc", pcfind.findByCode("library"),
				8,
				getPropertyDefinitionsPrcCapturePcrIndexing(), // FDS 19/03/2018 NGL-1906 ajout 
				Arrays.asList(
		...
		// FDS 14/12/2017 NGL-1730 : renommage label (ajout NovaSeq)
		l.add(DescriptionFactory.newProcessType("Prep. Capture reprise (2) (4000 / X5 / NovaSeq)", "capture-pcr-indexing-fc-ord", pcfind.findByCode("library"),
				9,
		...
		// FDS 14/12/2017 NGL-1730 : renommage label (suppression 2000 : ne sont plus en fonction)
		l.add(DescriptionFactory.newProcessType("Prep. Capture reprise (2) (2500 / NextSeq)", "capture-pcr-indexing-fc", pcfind.findByCode("library"),
				10,
				getPropertyDefinitionsCapturePcrIndexing(),
				Arrays.asList(
		...
		// FDS 14/12/2017 NGL-1730 : renommage label (ajout NovaSeq); 18/07/2018 renommage "capture" dans label
		l.add(DescriptionFactory.newProcessType("Capture reprise (3) (4000 / X5 / NovaSeq)", "pcr-indexing-process-fc-ord", pcfind.findByCode("library"),
				11,
				null,
				Arrays.asList(
		...
		// FDS 14/12/2017 NGL-1730 : renommage label (supression 2000 : ne sont plus en fonction); 18/07/2018 renommage "capture" dans label
		l.add(DescriptionFactory.newProcessType("Capture reprise (3) (2500 / NextSeq)", "pcr-indexing-process-fc", pcfind.findByCode("library"),
				12,
				null,
				Arrays.asList(
		...
		// FDS 09/10/2020 NGL-3128: ajout lib normalisée (au même niveau que norm + pooling)
		l.add(DescriptionFactory.newProcessType("Small RNAseq", "small-rna-seq-process", ProcessCategory.find.get().findByCode("library"),
				13,
				...
				Arrays.asList(
						...
						getPET("lib-normalization",1), // dans les nodes prepa-fc-ordered et denat-dil-lib  lib-normalization est deja en entree 
						getPET("prepa-fc-ordered",2),
						getPET("denat-dil-lib",2),       // 2 de meme niveau
						getPET("illumina-depot",3),
						getPET("prepa-flowcell",3),      // 2 de meme niveau
						getPET("illumina-depot",4)),     // defini une deuxieme fois car il y a 2 branches
		...
		l.add(DescriptionFactory.newProcessType("BisSeq (FC ordonnée)", "bis-seq-process-fc-ord", ProcessCategory.find.get().findByCode("library"),
				14,
		...
		// FDS ajout 04/06/2018 NGL-1728: processus (Ox)BisSeq
		l.add(DescriptionFactory.newProcessType("(Ox)BisSeq (FC ordonnée)", "oxbisseq-and-bisseq-process-fc-ord", ProcessCategory.find.get().findByCode("library"),
				15,
				null,  // pas de proprietes...
				Arrays.asList(
						getPET("ext-to-oxbisseq-and-bisseq-process-fc-ord",-1), //ordered list of experiment type in process type
						getPET("oxbisseq-and-bisseq-lib-prep",0),
						getPET("lib-normalization",1),
						getPET("normalization-and-pooling",1),   // 2 de meme niveau
						getPET("prepa-fc-ordered",2),
						getPET("illumina-depot",3)),
				getExperimentTypes("oxbisseq-and-bisseq-lib-prep").get(0),               //first experiment type
				getExperimentTypes("illumina-depot").get(0),                             //last  experiment type
				getExperimentTypes("ext-to-oxbisseq-and-bisseq-process-fc-ord").get(0),  //void  experiment type
				CNG));
		
		// FDS 26/10/2018 NGL-1226: processus RNAseq labo petit/moyen débit
		l.add(DescriptionFactory.newProcessType("RNAseq (DEV) frag, cDNA, indexing", "rna-seq-frg-cdna-indexing-process", pcfind.findByCode("library"),
				18,
				getPropertyDefinitionsRNAseqFrag(),
				Arrays.asList(
						getPET("ext-to-rna-seq-frg-cdna-indexing-process",-1), //ordered list of experiment type in process type
						getPET("frg-cdna-indexing",0),
						getPET("dev-pcr-amplification",1),
						getPET("lib-normalization",2) ),
				getExperimentTypes("frg-cdna-indexing").get(0),                        //first experiment type
				getExperimentTypes("lib-normalization").get(0),                        //last  experiment type
				getExperimentTypes("ext-to-rna-seq-frg-cdna-indexing-process").get(0), //void  experiment type
				CNG));
		
		// FDS 26/10/2018 NGL-1226: processus RNAseq labo petit/moyen débit
		l.add(DescriptionFactory.newProcessType("RNAseq (DEV) full length cDNA, frag indexing", "rna-seq-flcdna-frg-indexing-process", pcfind.findByCode("library"),
				19,
				getPropertyDefinitionsRNAseqFull(),
				Arrays.asList(
						getPET("ext-to-rna-seq-flcdna-frg-indexing-process",-1), //ordered list of experiment type in process type
						getPET("cdna-synthesis",0),
						getPET("lib-and-pcr",1),
						getPET("lib-normalization",2) ),  
				getExperimentTypes("cdna-synthesis").get(0),                             //first experiment type
				getExperimentTypes("lib-normalization").get(0),                          //last  experiment type
				getExperimentTypes("ext-to-rna-seq-flcdna-frg-indexing-process").get(0), //void  experiment type
				CNG));
		
		// FDS 14/12/2018 NGL-1226: processus de reprise
		l.add(DescriptionFactory.newProcessType("RNAseq (DEV) Prep Lib Nextera à partir de synthèse cDNA (reprise)", "rnaseq-frg-indexing-process-from-cdna", pcfind.findByCode("library"),
				20,
				getPropertyDefinitionsRNAseqFull(),// memes proprietes que RNAseqFull
				Arrays.asList(
						getPET("ext-to-rnaseq-frg-indexing-process-from-cdna",-1), //ordered list of experiment type in process type
						getPET("cdna-synthesis",-1),
						getPET("lib-and-pcr",0),
						getPET("lib-normalization",1) ),  
				getExperimentTypes("lib-and-pcr").get(0),                                //first experiment type
				getExperimentTypes("lib-normalization").get(0),                          //last  experiment type
				getExperimentTypes("ext-to-rnaseq-frg-indexing-process-from-cdna").get(0), //void  experiment type
				CNG));
		
		// FDS 30/04/2019 NGL-1725: processus ATACseq
		l.add(DescriptionFactory.newProcessType("ATAC-Seq", "atac-seq-process", pcfind.findByCode("library"),
				21,
				getPropertyDefinitionsATACseq(),
				Arrays.asList(
						getPET("ext-to-atac-seq-process",-1), //ordered list of experiment type in process type
						getPET("permeabilization-transposition-purification",0),
						getPET("pcr-amplif-and-purif-atac-chip-seq",1),
						getPET("lib-normalization",2),
						getPET("normalization-and-pooling",2), // ajout  14/10/2019 (NGL-2607)
						getPET("denat-dil-lib",3),
						getPET("prepa-fc-ordered",3),  // 2 de meme niveau
						getPET("illumina-depot",4),    // 2 de meme niveau
						getPET("prepa-flowcell",4),    // 2 de meme niveau
						getPET("illumina-depot",5) ),  // defini une deuxieme fois car il y a 2 branches
				getExperimentTypes("permeabilization-transposition-purification").get(0), //first experiment type
				getExperimentTypes("illumina-depot").get(0),                              //last  experiment type
				getExperimentTypes("ext-to-atac-seq-process").get(0),                     //void  experiment type
				CNG));
		
		// FDS 21/01/2020 NGL-2299: processus QMPSeq
		l.add(DescriptionFactory.newProcessType("QMPSeq", "qmp-seq-process", pcfind.findByCode("library"),
				22,
				getPropertyDefinitionsQMPseq(),
				Arrays.asList(
						getPET("ext-to-qmp-seq-process",-1), //ordered list of experiment type in process type
						getPET("bisulfite-conversion",0),
						getPET("qmp-lib-prep",1),
						getPET("pcr-indexing-and-purification-qmp-seq",2),
						getPET("normalization-and-pooling",3), 
						getPET("prepa-fc-ordered",4),
						getPET("illumina-depot",5) ),  
				getExperimentTypes("bisulfite-conversion").get(0),  //first experiment type
				getExperimentTypes("illumina-depot").get(0),        //last  experiment type
				getExperimentTypes("ext-to-qmp-seq-process").get(0),//void  experiment type
				CNG));
		
		// FDS 26/03/2020 NGL-2898 (1er processus made in confinement Covid-19 !!)
		// Ne pas lui mettre de propriétés, les containers qui arrivent en qmp-lib-prep seront obligatoirement passés par le process normal
		// et donc auront tout ce qu'il faut...
		// On ne veut pas de pas de None  en entree => suppression ext-to-qmp-seq-process-from-bisulfite-conversion" en -1;  
		// mais garder qd meme en void experiment type !!!
		l.add(DescriptionFactory.newProcessType("Reprise QMPSeq à partir de conversion bisulfite", "qmp-seq-process-from-bisulfite-conversion", pcfind.findByCode("library"),
				23,
				null,// pas de propriétés
				Arrays.asList(
						// getPET("ext-to-qmp-seq-process-from-bisulfite-conversion",-1),
						getPET("bisulfite-conversion",-1), //ordered list of experiment type in process type
						getPET("qmp-lib-prep",0),
						getPET("pcr-indexing-and-purification-qmp-seq",1),
						getPET("normalization-and-pooling",2), 
						getPET("prepa-fc-ordered",3),
						getPET("illumina-depot",4) ),  
				getExperimentTypes("qmp-lib-prep").get(0),          //first experiment type
				getExperimentTypes("illumina-depot").get(0),        //last  experiment type
				getExperimentTypes("ext-to-qmp-seq-process-from-bisulfite-conversion").get(0),//void  experiment type
				CNG));
		
		// FDS 05/05/2020 NGL-2844: processus OxQMPSeq
		l.add(DescriptionFactory.newProcessType("OxQMPSeq", "oxqmp-seq-process", pcfind.findByCode("library"),
				24,
				getPropertyDefinitionsOxQMPseq(),
				Arrays.asList(
						getPET("ext-to-oxqmp-seq-process",-1), //ordered list of experiment type in process type
						getPET("bisulfite-oxbisulfite-conversion",0),
						getPET("qmp-lib-prep",1),
						getPET("pcr-indexing-and-purification-qmp-seq",2),
						getPET("normalization-and-pooling",3), 
						getPET("prepa-fc-ordered",4),
						getPET("illumina-depot",5) ),  
				getExperimentTypes("bisulfite-oxbisulfite-conversion").get(0),  //first experiment type
				getExperimentTypes("illumina-depot").get(0),                    //last  experiment type
				getExperimentTypes("ext-to-oxqmp-seq-process").get(0),          //void  experiment type
				CNG));
		...
		// FDS 13/03/2017 NGL-1167 ajout "wg-chromium-lib-prep" en previous
		// FDS 13/09/2017 NGL-1201; ajout pcr+indexing en previous 
		// FDS 18/07/2018 NGL-1727  bisseq-lib-prep et oxbisseq-and-bisseq-lib-prep en previous 
		// FDS 02/10/2020 NGL-3116 ajout lib-and-pcr en previous
		l.add(DescriptionFactory.newProcessType("Norm(+pooling),FC ordonnée, dépôt (4000 / X5 / NovaSeq)", "norm-fc-ordered-depot", pcfind.findByCode("normalization"),
				20,
				null,  // pas de propriétés ??
				Arrays.asList(
						...
						getPET("pcr-and-indexing",-1), 
						getPET("wg-chromium-lib-prep",-1),
						getPET("small-rnaseq-lib-prep",-1),
						getPET("bisseq-lib-prep",-1), 
						getPET("oxbisseq-and-bisseq-lib-prep",-1),
						getPET("lib-and-pcr",-1),
						getPET("lib-normalization",0),
						getPET("normalization-and-pooling",0),    // 2 de meme niveau
		...
		// FDS 13/07/2017 NGL-1201 ajout pcr+indexing en en previous
		// FDS 14/12/2017 NGL-1730: renommage label (supprimer 2000 : ne sont plus en fonction)
		// FDS 18/07/2018 NGL-1727 small-rnaseq-lib-prep en previous
		// FDS 02/10/2020 NGL-3116 ajout lib-and-pcr en previous
		l.add(DescriptionFactory.newProcessType("Norm(+pooling), dénat, FC, dépôt (2500 / MiSeq / NextSeq)", "norm-and-pool-denat-fc-depot", pcfind.findByCode("normalization"),
				21,   
				null, // pas de propriétés ??
				Arrays.asList(
						...
						getPET("lib-normalization",0),          // 2 de meme niveau
		 ...
		 *-----------------"sequencing"--------------------
		 */
		// _FDS_:  renommer les 'ext' en donnant le nom du processus ex: ext-to-denat-dil-lib---> ext-to-illumina-run
		
		// FDS 14/12/2017 NGL-1730: renommage label (supprimer 2000 : ne sont plus en fonction)
		l.add(DescriptionFactory.newProcessType("Dénat, prep FC, dépôt (2500 / MiSeq / NextSeq)", "illumina-run", pcfind.findByCode("sequencing"),
				40,
		...
		// FDS 26/09/2019 NGL-2235 le meme que "illumina-run" mais avec transfert initial
		// FDS 05/12/2018 NGL-1226 renommage label (supprimer 2000 : ne sont plus en fonction)
		l.add(DescriptionFactory.newProcessType("Transfert puis Dénat, prep FC, dépôt (2500 / MiSeq / NextSeq)","tf-illumina-run", pcfind.findByCode("sequencing"),
				41,
		        getPropertyDefinitionsIlluminaDepotCNG("prepa-flowcell"),
				Arrays.asList(
						getPET("ext-to-tf-illumina-run",-1), // ordered list of experiment type in process type
						getPET("lib-normalization",-1), 
						getPET("normalization-and-pooling",-1),
						getPET("denat-dil-lib",0),
						getPET("prepa-flowcell",1),
						getPET("illumina-depot",2)),
				getExperimentTypes("pool").get(0),                   //first experiment type  pool ou n'import quelle exp de transfert
				getExperimentTypes("illumina-depot").get(0),         //last  experiment type
				getExperimentTypes("ext-to-tf-illumina-run").get(0), //void  experiment type
				CNG));
		
		
		// FDS 13/09/2017 NGL-1201: renommage label en "Prep FC, dépôt (2000/2500/MiSeq/NextSeq)"
		// FDS 14/12/2017 NGL-1730: renommage label (supprimer 2000 : ne sont plus en fonction)
		l.add(DescriptionFactory.newProcessType("Prep FC, dépôt (2500 / MiSeq / NextSeq)", "prepfc-depot", pcfind.findByCode("sequencing"),
				42,
				getPropertyDefinitionsIlluminaDepotCNG("prepa-flowcell"),
				Arrays.asList(
		...
		l.add(DescriptionFactory.newProcessType("Prep FC ordonnée, dépôt (4000 / X5 / NovaSeq)", "prepfcordered-depot", pcfind.findByCode("sequencing"),
				43,
		...
		// FDS 14/12/2017 NGL-1730: renomage label: ajout NovaSeq
		l.add(DescriptionFactory.newProcessType("Transfert puis prep FC ordonnée, dépôt (4000 / X5 / NovaSeq)", "tf-prepfcordered-depot", pcfind.findByCode("sequencing"),
				44,
				getPropertyDefinitionsIlluminaDepotCNG("prepa-fc-ordered"), 
				Arrays.asList(
						getPET("ext-to-prepa-fc-ordered",-1), //ordered list of experiment type in process type
		...
		l.add(DescriptionFactory.newProcessType("Transfert puis satellites", "transfert-qc-purif", pcfind.findByCode("satellites"), 
				60,
				null, // pas de propriétés ??
		...
		l.add(DescriptionFactory.newProcessType("QC puis satellites", "qc-transfert-purif", pcfind.findByCode("satellites"), 
				70,
				null, // pas de propriétés ??  
	...
	private static List<PropertyDefinition> getPropertyDefinitionsIlluminaDepotCNG(String expType) throws DAOException {
		...
		if ( expType.equals("prepa-flowcell")) {
			// HISEQ2000
			// 17/12/201 NGL-1226: demande de suppression de ces sequenceurs qui ne sont plus sur site. 07/01/2019 NON les remettre, necessaires pour l'historique
			...
			// 07/12/2017 NGL-1730 ajout NOVASEQ6000: MARIECURIX; 01/07/2019 NGL-2595 ajout SUPERNOVA
			// 13/02/2020 NGL-2863 aout BOSSANOVA
			listSequencers.addAll(DescriptionFactory.newValues("MARIECURIX","SUPERNOVA","BOSSANOVA"));
		}	

		/* JIRA NGL-2904 supression
	...
	private static List<PropertyDefinition> getPropertyDefinitionsX5WgPcrFree() throws DAOException {
		...
		propertyDefinitions.add(
				DescriptionFactory.newPropertiesDefinition("Type de séquençage","sequencingType",
	...
	//FDS 10/08/2016 renommer en getX5WgPcrFreeLibProcessTypeCodeValues
    // Liste evolutive !!!! voir aussi ImportServiceCNG (garder en coherence)
	private static List<Value> getX5WgPcrFreeLibProcessTypeCodeValues(){
        ...
        values.add(DescriptionFactory.newValue("DM","DM - DNAseq Low-pass")); // NGL-3258 ajout 17/02/2021
        return values;
	}
	...
	private static List<Value> getRNALibProcessTypeCodeValues(){
        ...
        values.add(DescriptionFactory.newValue("RI","RI - single cell mRNASeq Chromium"));        //single cell RNA sequencing
	...
	private static List<Value> getWgChromiumLibProcessTypeCodeValues(){
        ...
        values.add(DescriptionFactory.newValue("RI","RI - single cell mRNASeq Chromium")); // ajout 20/10/202O NGL-3141
	...
	// garder les valeurs strictement identiques avec celles de ImportService/getLibProcessTypeCodeValues
	private static List<Value> getCaptureLibProcessTypeCodeValues(){
		List<Value> values = new ArrayList<>();
		
		// Liste evolutive !!!! 05/09/2017 mise en coherence avec ImportService
	...
	private static List<Value>getCaptureBaitsValues() {
		...
		values.add(DescriptionFactory.newValue("V7","V7")); 
	...
	// FDS ajout 04/04/2018 pour NGL-1996 : processus BisSeq
	...
	private static List<Value> getBisSeqTypeCodeValues(){
		...
		// Liste evolutive !!!! voir ausii ImportServiceCNG (garder en coherence)
		values.add(DescriptionFactory.newValue("FD","FD - BisSeq"));
		
		return values;
	}
	
	// FDS ajout 26/10/2018 pour NGL-1226: processus RNAseqFrag
	private static List<PropertyDefinition> getPropertyDefinitionsRNAseqFrag() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
	
		propertyDefinitions.add(
				DescriptionFactory.newPropertiesDefinition("Type processus librairie","libProcessTypeCode",
						LevelService.getLevels(Level.CODE.Process,Level.CODE.Content) , String.class, true, "F",
						getRNAseqFragTypeCodeValues(), "single" ,100, null, null, null));
		
		return propertyDefinitions;
	}
	
	private static List<Value> getRNAseqFragTypeCodeValues(){
		List<Value> values = new ArrayList<>();
	...
	// FDS ajout 26/10/2018 pour NGL-1226: processus RNAseqFull
	private static List<PropertyDefinition> getPropertyDefinitionsRNAseqFull() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
	
		propertyDefinitions.add(
				DescriptionFactory.newPropertiesDefinition("Type processus librairie","libProcessTypeCode",
						LevelService.getLevels(Level.CODE.Process,Level.CODE.Content) , String.class, true, "F",
						getRNAseqFullTypeCodeValues(), "single" ,100, null, null, null));
		
		return propertyDefinitions;
	}
	
	private static List<Value> getRNAseqFullTypeCodeValues(){
		List<Value> values = new ArrayList<>();
	...
	// FDS ajout 30/04/2019 pour NGL-1725: processus ATACseq
	private static List<PropertyDefinition> getPropertyDefinitionsATACseq() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
	
		propertyDefinitions.add(
				DescriptionFactory.newPropertiesDefinition("Type processus librairie","libProcessTypeCode",
						LevelService.getLevels(Level.CODE.Process,Level.CODE.Content) , String.class, true, "F",
						getATACseqTypeCodeValues(), "single" ,100, null, null, null));
		
		return propertyDefinitions;
	}
	
	// FDS ajout 29/01/2020 pour NGL-2299: processus QMPseq
	private static List<PropertyDefinition> getPropertyDefinitionsQMPseq() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
	
		propertyDefinitions.add(
				DescriptionFactory.newPropertiesDefinition("Type processus librairie","libProcessTypeCode",
						LevelService.getLevels(Level.CODE.Process,Level.CODE.Content) , String.class, true, "F",
						getQMPseqTypeCodeValues(), "single" ,100, null, null, null));
		
		return propertyDefinitions;
	}
	
	private static List<Value> getQMPseqTypeCodeValues(){
		List<Value> values = new ArrayList<>();
		
		// Liste evolutive !!!! voir aussi ImportServiceCNG (garder en coherence)
		values.add(DescriptionFactory.newValue("FK","FK - QMPSeq"));
		
		return values;
	}
	
	// FDS ajout 05/05/2020 pour NGL-2844: processus OxQMPseq
	private static List<PropertyDefinition> getPropertyDefinitionsOxQMPseq() throws DAOException {
		List<PropertyDefinition> propertyDefinitions = new ArrayList<>();
	
		propertyDefinitions.add(
				DescriptionFactory.newPropertiesDefinition("Type processus librairie","libProcessTypeCode",
						LevelService.getLevels(Level.CODE.Process,Level.CODE.Content) , String.class, true, "F",
						getOxQMPseqTypeCodeValues(), "single" ,100, null, null, null));
		
		return propertyDefinitions;
	}
	
	private static List<Value> getOxQMPseqTypeCodeValues(){
		List<Value> values = new ArrayList<>();
		
		// Liste evolutive !!!! voir aussi ImportServiceCNG.java (garder en cohérence)
		values.add(DescriptionFactory.newValue("FKB","FKB - BsQMPSeq"));
		values.add(DescriptionFactory.newValue("FKO","FKO - OxQMPSeq"));
		
		return values;
	}
	
	private static List<Value> getATACseqTypeCodeValues(){
		List<Value> values = new ArrayList<>();

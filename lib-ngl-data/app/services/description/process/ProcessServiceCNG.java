...
public class ProcessServiceCNG  extends AbstractProcessService {
	...
	public void saveProcessCategories(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		l.add(DescriptionFactory.newProcessCategory("Normalisation", "normalization"));
	...
	public void saveProcessTypes(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		l.add(DescriptionFactory.newProcessType("Prep lib RNAseq", "rna-lib-process", pcfind.findByCode("library"),
				3,
		...
		l.add(DescriptionFactory.newProcessType("Prep Chromium WG (FC ordonnée)", "wg-chromium-lib-process", pcfind.findByCode("library"),
				4,
	...
	private static List<PropertyDefinition> getPropertyDefinitionsIlluminaDepotCNG(String expType) throws DAOException {
		...
		if ( expType.equals("prepa-flowcell")) {
			...
			listSequencers.addAll(DescriptionFactory.newValues("MARIECURIX","SUPERNOVA"));
		}	
		...
		propertyDefinitions.add(
				DescriptionFactory.newPropertiesDefinition("Type séquençage","sequencingType"

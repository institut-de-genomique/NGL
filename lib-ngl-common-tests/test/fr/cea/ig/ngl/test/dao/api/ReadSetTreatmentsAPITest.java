...
public class ReadSetTreatmentsAPITest {
    ...
    public static final CC3<TestContext, ReadSet, Treatment> illuminaData = TUResources.createIlluminaRunAndReadSetRWC
            .cc3((context, exp, refRun, run, refReadSet, readSet) -> {
                Treatment t = TestReadsetFactory.globalTreatment();
                Treatment treatment = context.apis().readsetTreatment().save(readSet, t, TUResources.USER);
    ...
    public void deleteTest() throws Exception {
        illuminaData.accept((context, readset, treatment) -> {
            api.get().delete(readset, treatment.code, TUResources.USER);
    ...
    public void deleteAllTest() throws Exception {
        illuminaData.accept((context, readset, treatment) -> {
            api.get().deleteAll(readset, TUResources.USER);
    ...
    public void saveTest() throws Exception {
        TUResources.createIlluminaRunAndReadSetRWC.accept((__, ___, ____, _____, refReadSet, readSet) -> {
            Treatment t = TestReadsetFactory.globalTreatment();
            Treatment treatment = api.get().save(readSet, t, TUResources.USER);
    ...
    public void updateTest() throws Exception {
        illuminaData.accept((context, readset, treatment) -> {
            ...
            Treatment tt = api.get().update(readset, t, TUResources.USER);

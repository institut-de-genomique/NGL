...
public class ContainerSupportsAPITest {
	...
	private static final String USER                = TUResources.USER;	
	
	//Tested API
	private static APIRef<ContainerSupportsAPI> api = APIRef.containerSupport;

	private static final CC2<ContainerSupport, ContainerSupport> supportResource = TUResources.createFullContainerOnTubeResource
			.cc2((refSample,refContainerSupport,containerSupport,refContainer,container) -> t2(refContainerSupport,containerSupport));

	private static final CC2<ContainerSupport,ContainerSupport> testData = TUResources.contextResource
			.nest2((context) 						 			 -> supportResource)
			.cc2((context, refContainerSupport,containerSupport) -> t2(refContainerSupport,containerSupport));
	
	public static final CC2< ContainerSupport, List<Container>> plateResource = TUResources.createPlateResourceWithContext

...
public class RunLanesAPITest {
    ...
    public static final CC3<TestContext, Run, Run> illuminaData = TUResources.createIlluminaRunAndReadSetRWC
    ...
    public void saveTest() throws Exception {
        illuminaData.accept((__, refRun, run) -> {
            ...
            Lane lane2 = api.get().save(run, input, TUResources.USER);
    ...
    public void updateTest() throws Exception {
        illuminaData
        .nest((context, refRun, run)         -> Actions.using(TUResources.USER, () -> TestReadsetFactory.readsetIllumina(TUResources.USER, run, 1)))
        ...
        .accept((__, run, readSet) -> {
            ...
            Lane output = api.get().update(run, lane, TUResources.USER);
    ...
    public void valuationTest() throws Exception {
        illuminaData.accept((__, refRun, run) -> {
            ...
            Lane l = api.get().valuation(run, 1, valuation, TUResources.USER);
    ...
    public void deleteAllLanesTest() throws Exception {
        illuminaData.accept((__, refRun, run) -> {
            ...
            api.get().deleteAllLanes(run, TUResources.USER);
    ...
    public void deleteTest() throws Exception {
        illuminaData.accept((__, refRun, run) -> {
            api.get().delete(run, 1, TUResources.USER);

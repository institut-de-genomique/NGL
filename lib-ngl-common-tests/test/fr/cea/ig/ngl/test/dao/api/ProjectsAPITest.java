...
//			.cc2 ((context, refProject, project) -> T.t2(refProject, project));
	...
	public void updateTest() throws Exception {
		testData.accept((proj0,proj1) -> {
			logger.debug("updateTest - begin");
			proj1.archive = ! proj1.archive;
			Project proj2 = api.get().update(proj1, USER);

			assertNotEquals(proj0.archive, proj2.archive);
			assertEquals   (proj1.archive, proj2.archive);
			logger.debug("updateTest - end");
		});
	}

...
public class ContWorflowsTest {
	...
	private static CC5<TestContext,ContainerSupport,List<Container>,ContextValidation,ContWorkflows> plateContext = 
			TUResources.createPlateResourceWithContext
			           .cc5((c, plate, wells) -> T.t5(c, plate, wells,
			        		                          ContextValidation.createUpdateContext(TUResources.USER), 
	...
	public void test_01n() throws Exception {
		plateContext.accept((c, plate, wells, vc, cwf) -> {
			cwf.setState(vc, wells.get(0), new State(ContainerStateNames.A_PF, TUResources.USER), "workflow", true);
		});
	}
	...
	public void test_01o() throws Exception {
		plateContext.accept((c, plate, wells, vc, cwf) -> {
			...
			cwf.setState(vc, wells.get(0), new State(ContainerStateNames.A_PF, TUResources.USER));
		});
	}
	...
	public void test_02n() throws Exception {
		plateContext.accept((c, plate, wells, vc, cwf) -> {
			cwf.setState(vc, wells.get(0), new State(ContainerStateNames.A_PF, TUResources.USER), "controllers", true);
		});
	}

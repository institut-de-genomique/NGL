...
/**
 * Test all configured entities lifecycle from {@link TUResources} to check if they works fine.
 * 
 * @author ajosso
 *
 */
...
//	}
	...
	public void plateFullWC() throws Exception {
		testResourceLifeCycle(TUResources.createPlateFullResourceWithContext.ct());
	}


    @Test
    public void expPrepFCIlluminaRWC() throws Exception {
        testResourceLifeCycle(TUResources.createExpPrepFCIlluminaRWC.ct());
    }
	
	@Test
    public void illuminaDepotRWC() throws Exception {
        testResourceLifeCycle(TUResources.createExpDepotIlluminaRWC.ct());
    }
	
    @Test
    public void illuminaRunRWC() throws Exception {
        testResourceLifeCycle(TUResources.createIlluminaRunRWC.ct());
    }

    
    @Test
    public void illuminaRunAndReadSetRWC() throws Exception {
        testResourceLifeCycle(TUResources.createIlluminaRunAndReadSetRWC.ct());
    }
    ...
    public void illuminaAnalysisRWC() throws Exception {
        testResourceLifeCycle(TUResources.createIlluminaAnalysisRWC.ct());
    }

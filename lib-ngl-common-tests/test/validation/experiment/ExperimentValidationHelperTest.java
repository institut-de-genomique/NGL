...
//			contextValidation.getContextObjects().put("stateCode", "F");
			contextValidation.putObject("stateCode", "F");
			ExperimentValidationHelper.validateResolutionCodes(contextValidation, ctx.experimentType.code, ctx.resolutionList);
			assertEquals(0, contextValidation.getErrors().size());
		});
	}
...
//			contextValidation.getContextObjects().put("stateCode", "F");
			contextValidation.putObject("stateCode", "F");
			ExperimentValidationHelper.validateResolutionCodes(contextValidation, ctx.experimentType.code, null);
			assertEquals(1, contextValidation.getErrors().size());
		});
	}
...
//			contextValidation.getContextObjects().put("stateCode", "F");
			contextValidation.putObject("stateCode", "F");
			ExperimentValidationHelper.validateResolutionCodes(contextValidation, "test", ctx.resolutionList);

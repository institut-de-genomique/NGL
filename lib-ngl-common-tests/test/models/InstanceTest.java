...
//	private static final play.Logger.ALogger logger = play.Logger.of(InstanceTest.class);
	...
	private static final class TestContext implements CC1Managed {

//		String             id;
//		ProjectType        sProjectType;
//		SampleType         sSampleType;
//		ExperimentType     sexpExperimentType;
//		InstrumentUsedType sIntrumentUsedType;
//		ContainerCategory  sContainerCategory;
//		State              sState;
...
//			// ExperimentType
//			sexpExperimentType = ExperimentType.find.get().findAll().get(0);
		}	
...
//	}
	...
	public void updateProject() throws DAOException {
		...
		ProjectCategory projectCategory = ProjectCategory.find.get().findByCode(project.categoryCode);
		assertThat(projectCategory).isNotNull();

		ProjectType projectType = ProjectType.find.get().findByCode(project.typeCode);
...
//	// -- evaluate if this is a real test as it does not look like one
////	@Test
...
//	}
//	
//	// TO DO: evaluate if this is a real test as it does not look like one
////	@Test
//	public void generateExperimentCode() throws InterruptedException {
//		Experiment e = new Experiment();
//		e.typeCode = "test-tt";
